...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class AdditionalReportInfoTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AdditionalReportInfo>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AdditionalReportInfo>().ThatIs(_ => !systemUnderTest.Version.IsEqualTo(_.Version));
        ...
        private static readonly ValidModelTestScenarios<AdditionalReportInfo> ValidModelTestScenarios = new ValidModelTestScenarios<AdditionalReportInfo>()
            .AddScenario(() =>
                new ValidModelTestScenario<AdditionalReportInfo>
                {
                    Name = "a dummy AdditionalReportInfo should be valid",
                    SystemUnderTest = A.Dummy<AdditionalReportInfo>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Version == null)
                {
                    actual.Version.AsTest().Must().BeNull();
                }
                else if (!actual.Version.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Version.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Version);
                }
