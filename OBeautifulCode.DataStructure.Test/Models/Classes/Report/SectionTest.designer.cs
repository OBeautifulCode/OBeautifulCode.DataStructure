...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Section> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Section>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Section>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Section> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Section>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Section> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Section>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Section>
                {
                    Name = "TreeTable should return same 'treeTable' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Section>();
        ...
        private static readonly DeepCloneWithTestScenarios<Section> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Section>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Section>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Section>().ThatIs(_ => !systemUnderTest.Format.IsEqualTo(_.Format));
        ...
        private static readonly Section ReferenceObjectForEquatableTestScenarios = A.Dummy<Section>();

        private static readonly EquatableTestScenarios<Section> EquatableTestScenarios = new EquatableTestScenarios<Section>()
            .AddScenario(() =>
        ...
        private static readonly ValidModelTestScenarios<Section> ValidModelTestScenarios = new ValidModelTestScenarios<Section>()
            .AddScenario(() =>
                new ValidModelTestScenario<Section>
                {
                    Name = "a dummy Section should be valid",
                    SystemUnderTest = A.Dummy<Section>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void Section___Should_implement_IModel_of_Section___When_reflecting()
            {
                // Arrange
                var type = typeof(Section);

                var expectedModelMethods = typeof(IModel<Section>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Section>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Section___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Section);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Section)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.TreeTable == null)
                {
                    actual.TreeTable.AsTest().Must().BeNull();
                }
                else if (!actual.TreeTable.GetType().IsValueType)
                {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Section)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Section).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                Section systemUnderTest1 = null;
                Section systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Section___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Section___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Section___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Section___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Section___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
