...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class ValidationChainTest
    {
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidationChain>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new ValidationChain(
                                             new ValidationStepBase[0].Concat(referenceObject.Steps).Concat(new ValidationStepBase[] { null }).Concat(referenceObject.Steps).ToList(),
                                             referenceObject.EndMessageOp,
                                             referenceObject.EndValidity);
        ...
        private static readonly ValidModelTestScenarios<ValidationChain> ValidModelTestScenarios = new ValidModelTestScenarios<ValidationChain>()
            .AddScenario(() =>
                new ValidModelTestScenario<ValidationChain>
                {
                    Name = "a dummy ValidationChain should be valid",
                    SystemUnderTest = A.Dummy<ValidationChain>(),
                });
