...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class DropdownSelectorTest
    {
        ...
        private static readonly ValidModelTestScenarios<DropdownSelector> ValidModelTestScenarios = new ValidModelTestScenarios<DropdownSelector>()
            .AddScenario(() =>
                new ValidModelTestScenario<DropdownSelector>
                {
                    Name = "a dummy DropdownSelector should be valid",
                    SystemUnderTest = A.Dummy<DropdownSelector>(),
                });
