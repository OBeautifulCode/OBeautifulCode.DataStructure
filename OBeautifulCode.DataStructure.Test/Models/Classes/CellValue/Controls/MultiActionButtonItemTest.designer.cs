...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<MultiActionButtonItem> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<MultiActionButtonItem>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<MultiActionButtonItem>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MultiActionButtonItem>();

                        var result = new SystemUnderTestExpectedStringRepresentation<MultiActionButtonItem>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.MultiActionButtonItem: Text = {systemUnderTest.Text?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Link = {systemUnderTest.Link?.ToString() ?? "<null>"}, Availability = {systemUnderTest.Availability.ToString() ?? "<null>"}, Media = {systemUnderTest.Media?.ToString() ?? "<null>"}, HoverOverText = {systemUnderTest.HoverOverText?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<MultiActionButtonItem> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<MultiActionButtonItem>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MultiActionButtonItem>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'text' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<MultiActionButtonItem>();

                        var result = new MultiActionButtonItem(
                                             null,
                                             referenceObject.Link,
                                             referenceObject.Availability,
                                             referenceObject.Media,
                                             referenceObject.HoverOverText);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MultiActionButtonItem>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'availability' is Availability.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<MultiActionButtonItem>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "availability", "Unknown", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<MultiActionButtonItem> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<MultiActionButtonItem>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MultiActionButtonItem>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<MultiActionButtonItem>
                        {
                            SystemUnderTest = new MultiActionButtonItem(
                                                      referenceObject.Text,
                                                      referenceObject.Link,
                                                      referenceObject.Availability,
                                                      referenceObject.Media,
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MultiActionButtonItem>
                {
                    Name = "Availability should return same 'availability' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<MultiActionButtonItem>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<MultiActionButtonItem>
                        {
                            SystemUnderTest = new MultiActionButtonItem(
                                                      ...
                                                      referenceObject.Media,
                                                      referenceObject.HoverOverText),
                            ExpectedPropertyValue = referenceObject.Availability,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MultiActionButtonItem>
                {
                    Name = "HoverOverText should return same 'hoverOverText' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<MultiActionButtonItem>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<MultiActionButtonItem>
                        {
                            SystemUnderTest = new MultiActionButtonItem(
                                                      ...
                                                      referenceObject.Media,
                                                      referenceObject.HoverOverText),
                            ExpectedPropertyValue = referenceObject.HoverOverText,
                        };

                        return result;
                    },
                    PropertyName = "HoverOverText",
                });

        private static readonly DeepCloneWithTestScenarios<MultiActionButtonItem> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MultiActionButtonItem>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MultiActionButtonItem>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MultiActionButtonItem>().ThatIs(_ => !systemUnderTest.Text.IsEqualTo(_.Text));

                        var result = new SystemUnderTestDeepCloneWithValue<MultiActionButtonItem>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MultiActionButtonItem>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MultiActionButtonItem>().ThatIs(_ => !systemUnderTest.Link.IsEqualTo(_.Link));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MultiActionButtonItem>
                {
                    Name = "DeepCloneWithAvailability should deep clone object and replace Availability with the provided availability",
                    WithPropertyName = "Availability",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MultiActionButtonItem>();

                        var referenceObject = A.Dummy<MultiActionButtonItem>().ThatIs(_ => !systemUnderTest.Availability.IsEqualTo(_.Availability));

                        var result = new SystemUnderTestDeepCloneWithValue<MultiActionButtonItem>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Availability,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MultiActionButtonItem>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MultiActionButtonItem>().ThatIs(_ => !systemUnderTest.Media.IsEqualTo(_.Media));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MultiActionButtonItem>
                {
                    Name = "DeepCloneWithHoverOverText should deep clone object and replace HoverOverText with the provided hoverOverText",
                    WithPropertyName = "HoverOverText",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MultiActionButtonItem>();

                        var referenceObject = A.Dummy<MultiActionButtonItem>().ThatIs(_ => !systemUnderTest.HoverOverText.IsEqualTo(_.HoverOverText));

                        var result = new SystemUnderTestDeepCloneWithValue<MultiActionButtonItem>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.HoverOverText,
                        };
        ...
        private static readonly MultiActionButtonItem ReferenceObjectForEquatableTestScenarios = A.Dummy<MultiActionButtonItem>();

        private static readonly EquatableTestScenarios<MultiActionButtonItem> EquatableTestScenarios = new EquatableTestScenarios<MultiActionButtonItem>()
            .AddScenario(() =>
                new EquatableTestScenario<MultiActionButtonItem>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MultiActionButtonItem[]
                    {
                        new MultiActionButtonItem(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                ReferenceObjectForEquatableTestScenarios.Link,
                                ReferenceObjectForEquatableTestScenarios.Availability,
                                ReferenceObjectForEquatableTestScenarios.Media,
                                ReferenceObjectForEquatableTestScenarios.HoverOverText),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new MultiActionButtonItem[]
                    {
                        new MultiActionButtonItem(
                                A.Dummy<MultiActionButtonItem>().Whose(_ => !_.Text.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Text)).Text,
                                ReferenceObjectForEquatableTestScenarios.Link,
                                ReferenceObjectForEquatableTestScenarios.Availability,
                                ReferenceObjectForEquatableTestScenarios.Media,
                                ReferenceObjectForEquatableTestScenarios.HoverOverText),
                        new MultiActionButtonItem(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                A.Dummy<MultiActionButtonItem>().Whose(_ => !_.Link.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Link)).Link,
                                ReferenceObjectForEquatableTestScenarios.Availability,
                                ReferenceObjectForEquatableTestScenarios.Media,
                                ReferenceObjectForEquatableTestScenarios.HoverOverText),
                        new MultiActionButtonItem(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                ReferenceObjectForEquatableTestScenarios.Link,
                                A.Dummy<MultiActionButtonItem>().Whose(_ => !_.Availability.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Availability)).Availability,
                                ReferenceObjectForEquatableTestScenarios.Media,
                                ReferenceObjectForEquatableTestScenarios.HoverOverText),
                        new MultiActionButtonItem(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                ReferenceObjectForEquatableTestScenarios.Link,
                                ReferenceObjectForEquatableTestScenarios.Availability,
                                A.Dummy<MultiActionButtonItem>().Whose(_ => !_.Media.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Media)).Media,
                                ReferenceObjectForEquatableTestScenarios.HoverOverText),
                        new MultiActionButtonItem(
                                ReferenceObjectForEquatableTestScenarios.Text,
                                ReferenceObjectForEquatableTestScenarios.Link,
                                ReferenceObjectForEquatableTestScenarios.Availability,
                                ReferenceObjectForEquatableTestScenarios.Media,
                                A.Dummy<MultiActionButtonItem>().Whose(_ => !_.HoverOverText.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HoverOverText)).HoverOverText),
                    },
        ...
        private static readonly ValidModelTestScenarios<MultiActionButtonItem> ValidModelTestScenarios = new ValidModelTestScenarios<MultiActionButtonItem>()
            .AddScenario(() =>
                new ValidModelTestScenario<MultiActionButtonItem>
                {
                    Name = "a dummy MultiActionButtonItem should be valid",
                    SystemUnderTest = A.Dummy<MultiActionButtonItem>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void MultiActionButtonItem___Should_implement_IModel_of_MultiActionButtonItem___When_reflecting()
            {
                // Arrange
                var type = typeof(MultiActionButtonItem);

                var expectedModelMethods = typeof(IModel<MultiActionButtonItem>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MultiActionButtonItem>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MultiActionButtonItem___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MultiActionButtonItem);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (MultiActionButtonItem)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Text", "Link", "Availability", "Media", "HoverOverText" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MultiActionButtonItem)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(MultiActionButtonItem).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MultiActionButtonItem>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                MultiActionButtonItem systemUnderTest1 = null;
                MultiActionButtonItem systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    MultiActionButtonItem systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MultiActionButtonItem___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MultiActionButtonItem___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MultiActionButtonItem___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MultiActionButtonItem___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MultiActionButtonItem___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
