...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class InlinedMediaTest
    {
        ...
        private static readonly ValidModelTestScenarios<InlinedMedia> ValidModelTestScenarios = new ValidModelTestScenarios<InlinedMedia>()
            .AddScenario(() =>
                new ValidModelTestScenario<InlinedMedia>
                {
                    Name = "a dummy InlinedMedia should be valid",
                    SystemUnderTest = A.Dummy<InlinedMedia>(),
                });
