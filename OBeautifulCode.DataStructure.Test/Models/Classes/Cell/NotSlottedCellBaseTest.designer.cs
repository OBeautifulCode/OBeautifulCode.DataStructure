...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly NotSlottedCellBase ReferenceObjectForEquatableTestScenarios = A.Dummy<NotSlottedCellBase>();

        private static readonly EquatableTestScenarios<NotSlottedCellBase> EquatableTestScenarios = new EquatableTestScenarios<NotSlottedCellBase>()
            .AddScenario(() =>
                new EquatableTestScenario<NotSlottedCellBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NotSlottedCellBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NotSlottedCellBase[]
                    {
                        ...
                        // (NotSlottedCellBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<NotSlottedCellBase>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        // (NotSlottedCellBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithColumnsSpanned(A.Dummy<NotSlottedCellBase>().Whose(_ => !_.ColumnsSpanned.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ColumnsSpanned)).ColumnsSpanned),
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithDefaultAvailability(A.Dummy<NotSlottedCellBase>().Whose(_ => !_.DefaultAvailability.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DefaultAvailability)).DefaultAvailability),
                    ...
                    {
                        A.Dummy<NotSlottedCellBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void NotSlottedCellBase___Should_implement_IModel_of_NotSlottedCellBase___When_reflecting()
            {
                // Arrange
                var type = typeof(NotSlottedCellBase);

                var expectedModelMethods = typeof(IModel<NotSlottedCellBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NotSlottedCellBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NotSlottedCellBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NotSlottedCellBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<NotSlottedCellBase>();

                // Act
                var actual = (NotSlottedCellBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NotSlottedCellBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                NotSlottedCellBase systemUnderTest1 = null;
                NotSlottedCellBase systemUnderTest2 = null;
