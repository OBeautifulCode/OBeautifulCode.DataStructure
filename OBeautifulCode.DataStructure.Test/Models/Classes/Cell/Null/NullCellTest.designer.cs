...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class NullCellTest
    {
        ...
        private static readonly ValidModelTestScenarios<NullCell> ValidModelTestScenarios = new ValidModelTestScenarios<NullCell>()
            .AddScenario(() =>
                new ValidModelTestScenario<NullCell>
                {
                    Name = "a dummy NullCell should be valid",
                    SystemUnderTest = A.Dummy<NullCell>(),
                });
