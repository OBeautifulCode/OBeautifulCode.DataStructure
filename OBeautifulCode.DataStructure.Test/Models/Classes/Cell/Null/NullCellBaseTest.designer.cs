            ...
            .AddScenario(() =>
                new EquatableTestScenario<NullCellBase>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new NullCellBase[]
                    {
                        ...
                        // (NullCellBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithInitialAvailability(A.Dummy<NullCellBase>().Whose(_ => !_.InitialAvailability.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InitialAvailability)).InitialAvailability),
