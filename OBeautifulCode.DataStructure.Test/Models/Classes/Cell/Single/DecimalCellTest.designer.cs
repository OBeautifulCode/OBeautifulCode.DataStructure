...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class DecimalCellTest
    {
                ...
                new StringRepresentationTestScenario<DecimalCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<DecimalCell>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.DecimalCell: Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, HoverOver = {systemUnderTest.HoverOver?.ToString() ?? "<null>"}, Link = {systemUnderTest.Link?.ToString() ?? "<null>"}, Value = {systemUnderTest.Value.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DisplayValue = {systemUnderTest.DisplayValue?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Format", "HoverOver", "Link", "Value", "DisplayValue" };
