...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class HtmlCellTest
    {
                ...
                new StringRepresentationTestScenario<HtmlCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<HtmlCell>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.HtmlCell: Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, HoverOver = {systemUnderTest.HoverOver?.ToString() ?? "<null>"}, Link = {systemUnderTest.Link?.ToString() ?? "<null>"}, Html = {systemUnderTest.Html?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Format", "HoverOver", "Link", "Html" };
