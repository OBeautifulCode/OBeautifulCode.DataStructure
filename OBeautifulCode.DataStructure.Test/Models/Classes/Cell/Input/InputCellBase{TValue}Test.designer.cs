...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class InputCellBaseTValueTest
    {
            ...
            .AddScenario(() =>
                new EquatableTestScenario<InputCellBase<Version>>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new InputCellBase<Version>[]
                    {
                        ...
                        // (InputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithDefaultAvailability(A.Dummy<InputCellBase<Version>>().Whose(_ => !_.DefaultAvailability.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DefaultAvailability)).DefaultAvailability),
        ...
        public static class Structural
        {
            ...
            public static void InputCellBase_of_Version___Should_implement_IModel_of_InputCellBase_of_Version___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void InputCellBase_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(InputCellBase<Version>);
