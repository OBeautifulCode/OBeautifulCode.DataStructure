            ...
            .AddScenario(() =>
                new EquatableTestScenario<StandardCellBase>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardCellBase[]
                    {
                        ...
                        // (StandardCellBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<StandardCellBase>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithFormat(A.Dummy<StandardCellBase>().Whose(_ => !_.Format.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Format)).Format),
