...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class ColumnSpanningMediaReferenceCellTest
    {
                ...
                new StringRepresentationTestScenario<ColumnSpanningMediaReferenceCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ColumnSpanningMediaReferenceCell>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.ColumnSpanningMediaReferenceCell: Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, HoverOver = {systemUnderTest.HoverOver?.ToString() ?? "<null>"}, Link = {systemUnderTest.Link?.ToString() ?? "<null>"}, ColumnsSpanned = {systemUnderTest.ColumnsSpanned.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, MediaReference = {systemUnderTest.MediaReference?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Format", "HoverOver", "Link", "ColumnsSpanned", "MediaReference" };
