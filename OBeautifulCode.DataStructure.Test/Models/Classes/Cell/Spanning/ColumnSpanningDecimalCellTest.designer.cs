...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class ColumnSpanningDecimalCellTest
    {
                ...
                new StringRepresentationTestScenario<ColumnSpanningDecimalCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ColumnSpanningDecimalCell>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.ColumnSpanningDecimalCell: Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, HoverOver = {systemUnderTest.HoverOver?.ToString() ?? "<null>"}, Link = {systemUnderTest.Link?.ToString() ?? "<null>"}, ColumnsSpanned = {systemUnderTest.ColumnsSpanned.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Value = {systemUnderTest.Value.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DisplayValue = {systemUnderTest.DisplayValue?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Format", "HoverOver", "Link", "ColumnsSpanned", "Value", "DisplayValue" };
