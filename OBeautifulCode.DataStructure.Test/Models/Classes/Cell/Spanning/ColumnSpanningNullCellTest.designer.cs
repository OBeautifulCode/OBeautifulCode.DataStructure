...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class ColumnSpanningNullCellTest
    {
                ...
                new StringRepresentationTestScenario<ColumnSpanningNullCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ColumnSpanningNullCell>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.ColumnSpanningNullCell: Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, HoverOver = {systemUnderTest.HoverOver?.ToString() ?? "<null>"}, Link = {systemUnderTest.Link?.ToString() ?? "<null>"}, ColumnsSpanned = {systemUnderTest.ColumnsSpanned.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, DisplayValue = {systemUnderTest.DisplayValue?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Format", "HoverOver", "Link", "ColumnsSpanned", "DisplayValue" };
