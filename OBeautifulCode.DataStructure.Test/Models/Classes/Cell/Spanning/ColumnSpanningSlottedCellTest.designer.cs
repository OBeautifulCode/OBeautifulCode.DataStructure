...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ColumnSpanningSlottedCell> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ColumnSpanningSlottedCell>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ColumnSpanningSlottedCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ColumnSpanningSlottedCell>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.ColumnSpanningSlottedCell: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SlotIdToCellMap = {systemUnderTest.SlotIdToCellMap?.ToString() ?? "<null>"}, DefaultSlotName = {systemUnderTest.DefaultSlotName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ColumnsSpanned = {systemUnderTest.ColumnsSpanned.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ColumnSpanningSlottedCell> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ColumnSpanningSlottedCell>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ColumnSpanningSlottedCell> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ColumnSpanningSlottedCell>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ColumnSpanningSlottedCell>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ColumnSpanningSlottedCell>
                        {
                            SystemUnderTest = new ColumnSpanningSlottedCell(
                                                      referenceObject.SlotIdToCellMap,
                                                      referenceObject.DefaultSlotName,
                                                      referenceObject.ColumnsSpanned,
                                                      referenceObject.Id),
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ColumnSpanningSlottedCell>
                {
                    Name = "DefaultSlotName should return same 'defaultSlotName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ColumnSpanningSlottedCell>();
        ...
        private static readonly DeepCloneWithTestScenarios<ColumnSpanningSlottedCell> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ColumnSpanningSlottedCell>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ColumnSpanningSlottedCell>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ColumnSpanningSlottedCell>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ColumnSpanningSlottedCell>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ColumnSpanningSlottedCell>().ThatIs(_ => !systemUnderTest.DefaultSlotName.IsEqualTo(_.DefaultSlotName));
        ...
        private static readonly ColumnSpanningSlottedCell ReferenceObjectForEquatableTestScenarios = A.Dummy<ColumnSpanningSlottedCell>();

        private static readonly EquatableTestScenarios<ColumnSpanningSlottedCell> EquatableTestScenarios = new EquatableTestScenarios<ColumnSpanningSlottedCell>()
            .AddScenario(() =>
                new EquatableTestScenario<ColumnSpanningSlottedCell>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new ColumnSpanningSlottedCell[]
                    {
                        new ColumnSpanningSlottedCell(
                                ...
                                ReferenceObjectForEquatableTestScenarios.DefaultSlotName,
                                ReferenceObjectForEquatableTestScenarios.ColumnsSpanned,
                                A.Dummy<ColumnSpanningSlottedCell>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        new ColumnSpanningSlottedCell(
                                A.Dummy<ColumnSpanningSlottedCell>().Whose(_ => !_.SlotIdToCellMap.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SlotIdToCellMap)).SlotIdToCellMap,
                                ReferenceObjectForEquatableTestScenarios.DefaultSlotName,
                                ReferenceObjectForEquatableTestScenarios.ColumnsSpanned,
                                ReferenceObjectForEquatableTestScenarios.Id),
                        new ColumnSpanningSlottedCell(
                                ReferenceObjectForEquatableTestScenarios.SlotIdToCellMap,
                                A.Dummy<ColumnSpanningSlottedCell>().Whose(_ => !_.DefaultSlotName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DefaultSlotName)).DefaultSlotName,
                                ReferenceObjectForEquatableTestScenarios.ColumnsSpanned,
                                ReferenceObjectForEquatableTestScenarios.Id),
                        new ColumnSpanningSlottedCell(
                                ReferenceObjectForEquatableTestScenarios.SlotIdToCellMap,
        ...
        public static class Structural
        {
            ...
            public static void ColumnSpanningSlottedCell___Should_implement_IModel_of_ColumnSpanningSlottedCell___When_reflecting()
            {
                // Arrange
                var type = typeof(ColumnSpanningSlottedCell);

                var expectedModelMethods = typeof(IModel<ColumnSpanningSlottedCell>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ColumnSpanningSlottedCell>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ColumnSpanningSlottedCell___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ColumnSpanningSlottedCell);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ColumnSpanningSlottedCell)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "SlotIdToCellMap", "DefaultSlotName", "ColumnsSpanned" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ColumnSpanningSlottedCell)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ColumnSpanningSlottedCell).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ColumnSpanningSlottedCell>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ColumnSpanningSlottedCell systemUnderTest1 = null;
                ColumnSpanningSlottedCell systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ColumnSpanningSlottedCell systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSpanningSlottedCell___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSpanningSlottedCell___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSpanningSlottedCell___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSpanningSlottedCell___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ColumnSpanningSlottedCell___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
