...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly OutputCellBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<OutputCellBase<Version>>();

        private static readonly EquatableTestScenarios<OutputCellBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<OutputCellBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<OutputCellBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new OutputCellBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new OutputCellBase<Version>[]
                    {
                        ...
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithId(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithColumnsSpanned(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.ColumnsSpanned.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ColumnsSpanned)).ColumnsSpanned),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithDetails(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithValidation(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.Validation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Validation)).Validation),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithValidationEvents(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.ValidationEvents.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ValidationEvents)).ValidationEvents),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithDefaultAvailability(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.DefaultAvailability.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DefaultAvailability)).DefaultAvailability),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithAvailabilityCheckEvents(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.AvailabilityCheckEvents.IsEqualTo(ReferenceObjectForEquatableTestScenarios.AvailabilityCheckEvents)).AvailabilityCheckEvents),
                        // (OutputCellBase<Version>)ReferenceObjectForEquatableTestScenarios.DeepCloneWithAvailabilityCheck(A.Dummy<OutputCellBase<Version>>().Whose(_ => !_.AvailabilityCheck.IsEqualTo(ReferenceObjectForEquatableTestScenarios.AvailabilityCheck)).AvailabilityCheck),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new OutputCellBase<Version>[]
                    {
                        A.Dummy<OutputCellBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void OutputCellBase_of_Version___Should_implement_IModel_of_OutputCellBase_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(OutputCellBase<Version>);

                var expectedModelMethods = typeof(IModel<OutputCellBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<OutputCellBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void OutputCellBase_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(OutputCellBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<OutputCellBase<Version>>();

                // Act
                var actual = (OutputCellBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<OutputCellBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                OutputCellBase<Version> systemUnderTest1 = null;
                OutputCellBase<Version> systemUnderTest2 = null;
