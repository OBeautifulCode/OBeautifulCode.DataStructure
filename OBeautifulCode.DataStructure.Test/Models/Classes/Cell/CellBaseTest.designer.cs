...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly CellBase ReferenceObjectForEquatableTestScenarios = A.Dummy<CellBase>();

        private static readonly EquatableTestScenarios<CellBase> EquatableTestScenarios = new EquatableTestScenarios<CellBase>()
            .AddScenario(() =>
                new EquatableTestScenario<CellBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CellBase[]
                    {
                    ...
                    {
                        A.Dummy<CellBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CellBase___Should_implement_IModel_of_CellBase___When_reflecting()
            {
                // Arrange
                var type = typeof(CellBase);

                var expectedModelMethods = typeof(IModel<CellBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<CellBase>();

                // Act
                var actual = (CellBase)systemUnderTest.Clone();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CellBase systemUnderTest1 = null;
                CellBase systemUnderTest2 = null;
