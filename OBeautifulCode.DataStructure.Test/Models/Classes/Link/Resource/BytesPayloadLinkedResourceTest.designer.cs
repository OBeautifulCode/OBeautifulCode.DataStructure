...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<BytesPayloadLinkedResource> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<BytesPayloadLinkedResource>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<BytesPayloadLinkedResource>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BytesPayloadLinkedResource>();

                        var result = new SystemUnderTestExpectedStringRepresentation<BytesPayloadLinkedResource>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.BytesPayloadLinkedResource: Bytes = {systemUnderTest.Bytes?.ToString() ?? "<null>"}, ResourceKind = {systemUnderTest.ResourceKind.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<BytesPayloadLinkedResource> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<BytesPayloadLinkedResource>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<BytesPayloadLinkedResource> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<BytesPayloadLinkedResource>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BytesPayloadLinkedResource>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<BytesPayloadLinkedResource>
                        {
                            SystemUnderTest = new BytesPayloadLinkedResource(
                                                      referenceObject.Bytes,
                                                      referenceObject.ResourceKind),
        ...
        private static readonly DeepCloneWithTestScenarios<BytesPayloadLinkedResource> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<BytesPayloadLinkedResource>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BytesPayloadLinkedResource>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BytesPayloadLinkedResource>().ThatIs(_ => !systemUnderTest.Bytes.IsEqualTo(_.Bytes));

                        var result = new SystemUnderTestDeepCloneWithValue<BytesPayloadLinkedResource>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BytesPayloadLinkedResource>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BytesPayloadLinkedResource>().ThatIs(_ => !systemUnderTest.ResourceKind.IsEqualTo(_.ResourceKind));
        ...
        private static readonly BytesPayloadLinkedResource ReferenceObjectForEquatableTestScenarios = A.Dummy<BytesPayloadLinkedResource>();

        private static readonly EquatableTestScenarios<BytesPayloadLinkedResource> EquatableTestScenarios = new EquatableTestScenarios<BytesPayloadLinkedResource>()
            .AddScenario(() =>
                new EquatableTestScenario<BytesPayloadLinkedResource>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new BytesPayloadLinkedResource[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new BytesPayloadLinkedResource[]
                    {
                        new BytesPayloadLinkedResource(
                                A.Dummy<BytesPayloadLinkedResource>().Whose(_ => !_.Bytes.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Bytes)).Bytes,
                                ReferenceObjectForEquatableTestScenarios.ResourceKind),
                        new BytesPayloadLinkedResource(
                                ReferenceObjectForEquatableTestScenarios.Bytes,
                                A.Dummy<BytesPayloadLinkedResource>().Whose(_ => !_.ResourceKind.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ResourceKind)).ResourceKind),
                    },
        ...
        private static readonly ValidModelTestScenarios<BytesPayloadLinkedResource> ValidModelTestScenarios = new ValidModelTestScenarios<BytesPayloadLinkedResource>()
            .AddScenario(() =>
                new ValidModelTestScenario<BytesPayloadLinkedResource>
                {
                    Name = "a dummy BytesPayloadLinkedResource should be valid",
                    SystemUnderTest = A.Dummy<BytesPayloadLinkedResource>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void BytesPayloadLinkedResource___Should_implement_IModel_of_BytesPayloadLinkedResource___When_reflecting()
            {
                // Arrange
                var type = typeof(BytesPayloadLinkedResource);

                var expectedModelMethods = typeof(IModel<BytesPayloadLinkedResource>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<BytesPayloadLinkedResource>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void BytesPayloadLinkedResource___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(BytesPayloadLinkedResource);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (BytesPayloadLinkedResource)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Bytes", "ResourceKind" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (BytesPayloadLinkedResource)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(BytesPayloadLinkedResource).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<BytesPayloadLinkedResource>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                BytesPayloadLinkedResource systemUnderTest1 = null;
                BytesPayloadLinkedResource systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    BytesPayloadLinkedResource systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BytesPayloadLinkedResource___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BytesPayloadLinkedResource___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BytesPayloadLinkedResource___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BytesPayloadLinkedResource___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BytesPayloadLinkedResource___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
