...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class UrlLinkedResourceTest
    {
        ...
        private static readonly ValidModelTestScenarios<UrlLinkedResource> ValidModelTestScenarios = new ValidModelTestScenarios<UrlLinkedResource>()
            .AddScenario(() =>
                new ValidModelTestScenario<UrlLinkedResource>
                {
                    Name = "a dummy UrlLinkedResource should be valid",
                    SystemUnderTest = A.Dummy<UrlLinkedResource>(),
                });
