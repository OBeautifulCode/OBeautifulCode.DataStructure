...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class NullLinkedResourceTest
    {
        ...
        private static readonly ValidModelTestScenarios<NullLinkedResource> ValidModelTestScenarios = new ValidModelTestScenarios<NullLinkedResource>()
            .AddScenario(() =>
                new ValidModelTestScenario<NullLinkedResource>
                {
                    Name = "a dummy NullLinkedResource should be valid",
                    SystemUnderTest = A.Dummy<NullLinkedResource>(),
                });
