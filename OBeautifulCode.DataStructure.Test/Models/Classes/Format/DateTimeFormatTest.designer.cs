...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DateTimeFormat> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DateTimeFormat>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DateTimeFormat>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DateTimeFormat> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DateTimeFormat>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DateTimeFormat>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'formatKind' is DateTimeFormatKind.Unknown",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "formatKind", "Unknown", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DateTimeFormat>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'cultureKind' is CultureKind.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<DateTimeFormat>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentOutOfRangeException),
                    ExpectedExceptionMessageContains = new[] { "cultureKind", "Unknown", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DateTimeFormat>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'localTimeZone' is StandardTimeZone.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<DateTimeFormat>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentOutOfRangeException),
                    ExpectedExceptionMessageContains = new[] { "localTimeZone", "Unknown", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<DateTimeFormat> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DateTimeFormat>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DateTimeFormat>
                {
                    Name = "FormatKind should return same 'formatKind' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<DateTimeFormat>();

                        var result = new SystemUnderTestExpectedPropertyValue<DateTimeFormat>
                        {
        ...
        private static readonly DeepCloneWithTestScenarios<DateTimeFormat> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DateTimeFormat>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DateTimeFormat>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DateTimeFormat>().ThatIs(_ => !systemUnderTest.LocalTimeZone.IsEqualTo(_.LocalTimeZone));
        ...
        private static readonly DateTimeFormat ReferenceObjectForEquatableTestScenarios = A.Dummy<DateTimeFormat>();

        private static readonly EquatableTestScenarios<DateTimeFormat> EquatableTestScenarios = new EquatableTestScenarios<DateTimeFormat>()
            .AddScenario(() =>
                new EquatableTestScenario<DateTimeFormat>
                {
                    Name = "Default Code Generated Scenario",
        ...
        private static readonly ValidModelTestScenarios<DateTimeFormat> ValidModelTestScenarios = new ValidModelTestScenarios<DateTimeFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<DateTimeFormat>
                {
                    Name = "a dummy DateTimeFormat should be valid",
                    SystemUnderTest = A.Dummy<DateTimeFormat>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void DateTimeFormat___Should_implement_IModel_of_DateTimeFormat___When_reflecting()
            {
                // Arrange
                var type = typeof(DateTimeFormat);

                var expectedModelMethods = typeof(IModel<DateTimeFormat>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DateTimeFormat>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DateTimeFormat___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DateTimeFormat);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DateTimeFormat)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DateTimeFormat)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DateTimeFormat).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DateTimeFormat>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                DateTimeFormat systemUnderTest1 = null;
                DateTimeFormat systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DateTimeFormat systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DateTimeFormat___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DateTimeFormat___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DateTimeFormat___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DateTimeFormat___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DateTimeFormat___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
