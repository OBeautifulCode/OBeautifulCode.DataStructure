...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class FontFormatTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<FontFormat> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<FontFormat>()
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<FontFormat>
                {
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "fontNamesInFallbackOrder", "contains an element that is white space", },
                });
        ...
        private static readonly ValidModelTestScenarios<FontFormat> ValidModelTestScenarios = new ValidModelTestScenarios<FontFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<FontFormat>
                {
                    Name = "a dummy FontFormat should be valid",
                    SystemUnderTest = A.Dummy<FontFormat>(),
                });
