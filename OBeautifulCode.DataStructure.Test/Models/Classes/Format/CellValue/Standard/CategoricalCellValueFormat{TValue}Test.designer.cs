...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class CategoricalCellValueFormatTValueTest
    {
        ...
        private static readonly ValidModelTestScenarios<CategoricalCellValueFormat<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<CategoricalCellValueFormat<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<CategoricalCellValueFormat<Version>>
                {
                    Name = "a dummy CategoricalCellValueFormat<Version> should be valid",
                    SystemUnderTest = A.Dummy<CategoricalCellValueFormat<Version>>(),
                });
