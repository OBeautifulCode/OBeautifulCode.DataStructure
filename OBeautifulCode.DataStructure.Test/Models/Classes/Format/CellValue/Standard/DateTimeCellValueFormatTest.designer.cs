...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class DateTimeCellValueFormatTest
    {
        ...
        private static readonly ValidModelTestScenarios<DateTimeCellValueFormat> ValidModelTestScenarios = new ValidModelTestScenarios<DateTimeCellValueFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<DateTimeCellValueFormat>
                {
                    Name = "a dummy DateTimeCellValueFormat should be valid",
                    SystemUnderTest = A.Dummy<DateTimeCellValueFormat>(),
                });
