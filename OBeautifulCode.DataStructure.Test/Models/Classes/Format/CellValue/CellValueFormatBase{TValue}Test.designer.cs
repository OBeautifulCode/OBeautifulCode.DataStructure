...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly CellValueFormatBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<CellValueFormatBase<Version>>();

        private static readonly EquatableTestScenarios<CellValueFormatBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<CellValueFormatBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<CellValueFormatBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellValueFormatBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CellValueFormatBase<Version>[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new CellValueFormatBase<Version>[]
                    {
                        A.Dummy<CellValueFormatBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CellValueFormatBase_of_Version___Should_implement_IModel_of_CellValueFormatBase_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(CellValueFormatBase<Version>);

                var expectedModelMethods = typeof(IModel<CellValueFormatBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellValueFormatBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellValueFormatBase_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellValueFormatBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<CellValueFormatBase<Version>>();

                // Act
                var actual = (CellValueFormatBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellValueFormatBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CellValueFormatBase<Version> systemUnderTest1 = null;
                CellValueFormatBase<Version> systemUnderTest2 = null;
