...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StandardCellValueFormatBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<StandardCellValueFormatBase<Version>>();

        private static readonly EquatableTestScenarios<StandardCellValueFormatBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<StandardCellValueFormatBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<StandardCellValueFormatBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StandardCellValueFormatBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new StandardCellValueFormatBase<Version>[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void StandardCellValueFormatBase_of_Version___Should_implement_IModel_of_StandardCellValueFormatBase_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(StandardCellValueFormatBase<Version>);

                var expectedModelMethods = typeof(IModel<StandardCellValueFormatBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StandardCellValueFormatBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardCellValueFormatBase_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardCellValueFormatBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<StandardCellValueFormatBase<Version>>();

                // Act
                var actual = (StandardCellValueFormatBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StandardCellValueFormatBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                StandardCellValueFormatBase<Version> systemUnderTest1 = null;
                StandardCellValueFormatBase<Version> systemUnderTest2 = null;
