...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<FillPattern> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<FillPattern>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<FillPattern>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FillPattern>();

                        var result = new SystemUnderTestExpectedStringRepresentation<FillPattern>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.FillPattern: Style = {systemUnderTest.Style.ToString() ?? "<null>"}, Color = {systemUnderTest.Color.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<FillPattern> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<FillPattern>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<FillPattern> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<FillPattern>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FillPattern>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<FillPattern>
                        {
                            SystemUnderTest = new FillPattern(
        ...
        private static readonly DeepCloneWithTestScenarios<FillPattern> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<FillPattern>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FillPattern>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<FillPattern>().ThatIs(_ => !systemUnderTest.Style.IsEqualTo(_.Style));

                        var result = new SystemUnderTestDeepCloneWithValue<FillPattern>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FillPattern>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<FillPattern>().ThatIs(_ => !systemUnderTest.Color.IsEqualTo(_.Color));
        ...
        private static readonly FillPattern ReferenceObjectForEquatableTestScenarios = A.Dummy<FillPattern>();

        private static readonly EquatableTestScenarios<FillPattern> EquatableTestScenarios = new EquatableTestScenarios<FillPattern>()
            .AddScenario(() =>
                new EquatableTestScenario<FillPattern>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new FillPattern[]
                    {
                        new FillPattern(
                                ReferenceObjectForEquatableTestScenarios.Style,
                                ReferenceObjectForEquatableTestScenarios.Color),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new FillPattern[]
                    {
                        new FillPattern(
                                A.Dummy<FillPattern>().Whose(_ => !_.Style.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Style)).Style,
                                ReferenceObjectForEquatableTestScenarios.Color),
                        new FillPattern(
                                ReferenceObjectForEquatableTestScenarios.Style,
                                A.Dummy<FillPattern>().Whose(_ => !_.Color.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Color)).Color),
                    },
        ...
        private static readonly ValidModelTestScenarios<FillPattern> ValidModelTestScenarios = new ValidModelTestScenarios<FillPattern>()
            .AddScenario(() =>
                new ValidModelTestScenario<FillPattern>
                {
                    Name = "a dummy FillPattern should be valid",
                    SystemUnderTest = A.Dummy<FillPattern>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void FillPattern___Should_implement_IModel_of_FillPattern___When_reflecting()
            {
                // Arrange
                var type = typeof(FillPattern);

                var expectedModelMethods = typeof(IModel<FillPattern>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<FillPattern>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FillPattern___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FillPattern);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (FillPattern)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Style", "Color" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (FillPattern)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(FillPattern).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<FillPattern>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                FillPattern systemUnderTest1 = null;
                FillPattern systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    FillPattern systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FillPattern___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FillPattern___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FillPattern___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FillPattern___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FillPattern___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
