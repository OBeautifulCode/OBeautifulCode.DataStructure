...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ReportFormat> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ReportFormat>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ReportFormat>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ReportFormat> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ReportFormat>()
            .AddScenario(() =>
                ...
                {
                    Name = "DisplayTimestamp should return same 'displayTimestamp' parameter passed to constructor when getting",
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReportFormat>
                {
                    Name = "TimestampFormat should return same 'timestampFormat' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReportFormat>();
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReportFormat>
                {
                    Name = "ReadOnly should return same 'readOnly' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReportFormat>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ReportFormat>
                        {
                            SystemUnderTest = new ReportFormat(
                                                      ...
                                                      referenceObject.RenderMode,
                                                      referenceObject.ReadOnly),
                            ExpectedPropertyValue = referenceObject.ReadOnly,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<ReportFormat> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ReportFormat>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithDisplayTimestamp should deep clone object and replace DisplayTimestamp with the provided displayTimestamp",
                    WithPropertyName = "DisplayTimestamp",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ReportFormat>();

                        var referenceObject = A.Dummy<ReportFormat>().ThatIs(_ => !systemUnderTest.DisplayTimestamp.IsEqualTo(_.DisplayTimestamp));

                        var result = new SystemUnderTestDeepCloneWithValue<ReportFormat>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.DisplayTimestamp,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReportFormat>
                {
                    Name = "DeepCloneWithReadOnly should deep clone object and replace ReadOnly with the provided readOnly",
                    WithPropertyName = "ReadOnly",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ReportFormat>();

                        var referenceObject = A.Dummy<ReportFormat>().ThatIs(_ => !systemUnderTest.ReadOnly.IsEqualTo(_.ReadOnly));

                        var result = new SystemUnderTestDeepCloneWithValue<ReportFormat>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ReadOnly,
                        };
        ...
        private static readonly EquatableTestScenarios<ReportFormat> EquatableTestScenarios = new EquatableTestScenarios<ReportFormat>()
            .AddScenario(() =>
                new EquatableTestScenario<ReportFormat>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ReportFormat[]
                    {
                        new ReportFormat(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ReadOnly),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ReportFormat[]
                    {
                        ...
                        new ReportFormat(
                                ...
                                ReferenceObjectForEquatableTestScenarios.Options,
                                ReferenceObjectForEquatableTestScenarios.RenderMode,
                                A.Dummy<ReportFormat>().Whose(_ => !_.ReadOnly.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ReadOnly)).ReadOnly),
                    },
        ...
        private static readonly ValidModelTestScenarios<ReportFormat> ValidModelTestScenarios = new ValidModelTestScenarios<ReportFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<ReportFormat>
                {
                    Name = "a dummy ReportFormat should be valid",
                    SystemUnderTest = A.Dummy<ReportFormat>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ReportFormat___Should_implement_IModel_of_ReportFormat___When_reflecting()
            {
                // Arrange
                var type = typeof(ReportFormat);

                var expectedModelMethods = typeof(IModel<ReportFormat>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ReportFormat>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ReportFormat___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ReportFormat);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ReportFormat)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.TimestampFormat == null)
                {
                    actual.TimestampFormat.AsTest().Must().BeNull();
                }
                else if (!actual.TimestampFormat.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.TimestampFormat.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.TimestampFormat);
                }
            }
            ...
            {
                var propertyNames = new string[] { "DisplayTimestamp", "TimestampFormat", "Options", "RenderMode", "ReadOnly" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ReportFormat)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ReportFormat).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ReportFormat>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ReportFormat systemUnderTest1 = null;
                ReportFormat systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ReportFormat systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReportFormat___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReportFormat___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReportFormat___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReportFormat___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReportFormat___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
