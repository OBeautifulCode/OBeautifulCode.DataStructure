...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<SectionFormat> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<SectionFormat>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<SectionFormat>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<SectionFormat>();

                        var result = new SystemUnderTestExpectedStringRepresentation<SectionFormat>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.SectionFormat: Options = {systemUnderTest.Options?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SectionFormat> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SectionFormat>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<SectionFormat> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SectionFormat>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SectionFormat>
                {
                    Name = "Options should return same 'options' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<SectionFormat>();

                        var result = new SystemUnderTestExpectedPropertyValue<SectionFormat>
                        {
                            SystemUnderTest = new SectionFormat(
        ...
        private static readonly DeepCloneWithTestScenarios<SectionFormat> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<SectionFormat>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<SectionFormat>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<SectionFormat>().ThatIs(_ => !systemUnderTest.Options.IsEqualTo(_.Options));

                        var result = new SystemUnderTestDeepCloneWithValue<SectionFormat>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly SectionFormat ReferenceObjectForEquatableTestScenarios = A.Dummy<SectionFormat>();

        private static readonly EquatableTestScenarios<SectionFormat> EquatableTestScenarios = new EquatableTestScenarios<SectionFormat>()
            .AddScenario(() =>
                new EquatableTestScenario<SectionFormat>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new SectionFormat[]
                    {
                        new SectionFormat(
                                ReferenceObjectForEquatableTestScenarios.Options),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new SectionFormat[]
                    {
                        new SectionFormat(
                                A.Dummy<SectionFormat>().Whose(_ => !_.Options.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Options)).Options),
                    },
        ...
        private static readonly ValidModelTestScenarios<SectionFormat> ValidModelTestScenarios = new ValidModelTestScenarios<SectionFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<SectionFormat>
                {
                    Name = "a dummy SectionFormat should be valid",
                    SystemUnderTest = A.Dummy<SectionFormat>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void SectionFormat___Should_implement_IModel_of_SectionFormat___When_reflecting()
            {
                // Arrange
                var type = typeof(SectionFormat);

                var expectedModelMethods = typeof(IModel<SectionFormat>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<SectionFormat>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void SectionFormat___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(SectionFormat);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (SectionFormat)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Options" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (SectionFormat)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(SectionFormat).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<SectionFormat>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                SectionFormat systemUnderTest1 = null;
                SectionFormat systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    SectionFormat systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SectionFormat___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SectionFormat___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SectionFormat___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SectionFormat___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_SectionFormat___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
