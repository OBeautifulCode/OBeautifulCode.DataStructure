...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class RowFormatTest
    {
        ...
        private static readonly ValidModelTestScenarios<RowFormat> ValidModelTestScenarios = new ValidModelTestScenarios<RowFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<RowFormat>
                {
                    Name = "a dummy RowFormat should be valid",
                    SystemUnderTest = A.Dummy<RowFormat>(),
                });
