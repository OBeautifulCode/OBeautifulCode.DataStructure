...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class ColumnFormatTest
    {
        ...
        private static readonly ValidModelTestScenarios<ColumnFormat> ValidModelTestScenarios = new ValidModelTestScenarios<ColumnFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<ColumnFormat>
                {
                    Name = "a dummy ColumnFormat should be valid",
                    SystemUnderTest = A.Dummy<ColumnFormat>(),
                });
