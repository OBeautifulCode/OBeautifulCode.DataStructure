...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class TableFormatTest
    {
        ...
        private static readonly ValidModelTestScenarios<TableFormat> ValidModelTestScenarios = new ValidModelTestScenarios<TableFormat>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableFormat>
                {
                    Name = "a dummy TableFormat should be valid",
                    SystemUnderTest = A.Dummy<TableFormat>(),
                });
