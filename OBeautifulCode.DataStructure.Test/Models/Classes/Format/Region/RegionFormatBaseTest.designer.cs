...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly RegionFormatBase ReferenceObjectForEquatableTestScenarios = A.Dummy<RegionFormatBase>();

        private static readonly EquatableTestScenarios<RegionFormatBase> EquatableTestScenarios = new EquatableTestScenarios<RegionFormatBase>()
            .AddScenario(() =>
                new EquatableTestScenario<RegionFormatBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RegionFormatBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new RegionFormatBase[]
                    {
                    ...
                    {
                        A.Dummy<RegionFormatBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void RegionFormatBase___Should_implement_IModel_of_RegionFormatBase___When_reflecting()
            {
                // Arrange
                var type = typeof(RegionFormatBase);

                var expectedModelMethods = typeof(IModel<RegionFormatBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RegionFormatBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RegionFormatBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RegionFormatBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<RegionFormatBase>();

                // Act
                var actual = (RegionFormatBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RegionFormatBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                RegionFormatBase systemUnderTest1 = null;
                RegionFormatBase systemUnderTest2 = null;
