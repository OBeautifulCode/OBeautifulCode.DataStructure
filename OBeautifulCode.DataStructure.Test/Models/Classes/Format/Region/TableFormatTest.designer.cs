...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class TableFormatTest
    {
                ...
                new StringRepresentationTestScenario<TableFormat>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TableFormat>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.TableFormat: CellsFormat = {systemUnderTest.CellsFormat?.ToString() ?? "<null>"}, OuterBorders = {systemUnderTest.OuterBorders?.ToString() ?? "<null>"}, InnerBorders = {systemUnderTest.InnerBorders?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "CellsFormat", "OuterBorders", "InnerBorders" };
