...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class AvailabilityCheckStepTest
    {
        ...
        private static readonly ValidModelTestScenarios<AvailabilityCheckStep> ValidModelTestScenarios = new ValidModelTestScenarios<AvailabilityCheckStep>()
            .AddScenario(() =>
                new ValidModelTestScenario<AvailabilityCheckStep>
                {
                    Name = "a dummy AvailabilityCheckStep should be valid",
                    SystemUnderTest = A.Dummy<AvailabilityCheckStep>(),
                });
