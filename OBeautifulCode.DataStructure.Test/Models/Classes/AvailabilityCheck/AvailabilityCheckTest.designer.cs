...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AvailabilityCheck> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AvailabilityCheck>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AvailabilityCheck>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AvailabilityCheck> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AvailabilityCheck>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<AvailabilityCheck> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AvailabilityCheck>()
            .AddScenario(() =>
        ...
        private static readonly DeepCloneWithTestScenarios<AvailabilityCheck> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AvailabilityCheck>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AvailabilityCheck>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AvailabilityCheck>().ThatIs(_ => !systemUnderTest.Operation.IsEqualTo(_.Operation));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AvailabilityCheck>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AvailabilityCheck>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly AvailabilityCheck ReferenceObjectForEquatableTestScenarios = A.Dummy<AvailabilityCheck>();

        private static readonly EquatableTestScenarios<AvailabilityCheck> EquatableTestScenarios = new EquatableTestScenarios<AvailabilityCheck>()
            .AddScenario(() =>
                new EquatableTestScenario<AvailabilityCheck>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AvailabilityCheck[]
                    {
        ...
        private static readonly ValidModelTestScenarios<AvailabilityCheck> ValidModelTestScenarios = new ValidModelTestScenarios<AvailabilityCheck>()
            .AddScenario(() =>
                new ValidModelTestScenario<AvailabilityCheck>
                {
                    Name = "a dummy AvailabilityCheck should be valid",
                    SystemUnderTest = A.Dummy<AvailabilityCheck>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void AvailabilityCheck___Should_implement_IModel_of_AvailabilityCheck___When_reflecting()
            {
                // Arrange
                var type = typeof(AvailabilityCheck);

                var expectedModelMethods = typeof(IModel<AvailabilityCheck>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AvailabilityCheck>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AvailabilityCheck___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AvailabilityCheck);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AvailabilityCheck)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AvailabilityCheck)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AvailabilityCheck).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AvailabilityCheck>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                AvailabilityCheck systemUnderTest1 = null;
                AvailabilityCheck systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AvailabilityCheck systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AvailabilityCheck___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AvailabilityCheck___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AvailabilityCheck___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AvailabilityCheck___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AvailabilityCheck___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
