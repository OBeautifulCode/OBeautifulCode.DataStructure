...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HtmlHoverOver> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HtmlHoverOver>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HtmlHoverOver>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HtmlHoverOver>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HtmlHoverOver>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.HtmlHoverOver: Html = {systemUnderTest.Html?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HtmlHoverOver> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HtmlHoverOver>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HtmlHoverOver>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'html' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HtmlHoverOver(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HtmlHoverOver> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HtmlHoverOver>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HtmlHoverOver>
                {
                    Name = "Html should return same 'html' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HtmlHoverOver>();

                        var result = new SystemUnderTestExpectedPropertyValue<HtmlHoverOver>
                        {
                            SystemUnderTest = new HtmlHoverOver(
        ...
        private static readonly DeepCloneWithTestScenarios<HtmlHoverOver> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HtmlHoverOver>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HtmlHoverOver>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HtmlHoverOver>().ThatIs(_ => !systemUnderTest.Html.IsEqualTo(_.Html));

                        var result = new SystemUnderTestDeepCloneWithValue<HtmlHoverOver>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HtmlHoverOver ReferenceObjectForEquatableTestScenarios = A.Dummy<HtmlHoverOver>();

        private static readonly EquatableTestScenarios<HtmlHoverOver> EquatableTestScenarios = new EquatableTestScenarios<HtmlHoverOver>()
            .AddScenario(() =>
                new EquatableTestScenario<HtmlHoverOver>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HtmlHoverOver[]
                    {
                        new HtmlHoverOver(
                                ReferenceObjectForEquatableTestScenarios.Html),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HtmlHoverOver[]
                    {
                        new HtmlHoverOver(
                                A.Dummy<HtmlHoverOver>().Whose(_ => !_.Html.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Html)).Html),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<StringHoverOver>(),
                    },
                });

        private static readonly ValidModelTestScenarios<HtmlHoverOver> ValidModelTestScenarios = new ValidModelTestScenarios<HtmlHoverOver>()
            .AddScenario(() =>
                new ValidModelTestScenario<HtmlHoverOver>
                {
                    Name = "a dummy HtmlHoverOver should be valid",
                    SystemUnderTest = A.Dummy<HtmlHoverOver>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void HtmlHoverOver___Should_implement_IModel_of_HtmlHoverOver___When_reflecting()
            {
                // Arrange
                var type = typeof(HtmlHoverOver);

                var expectedModelMethods = typeof(IModel<HtmlHoverOver>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HtmlHoverOver>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HtmlHoverOver___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HtmlHoverOver);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HtmlHoverOver)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Html" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HtmlHoverOver)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HtmlHoverOver).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HtmlHoverOver>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HtmlHoverOver systemUnderTest1 = null;
                HtmlHoverOver systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HtmlHoverOver systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HoverOverBase___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    HoverOverBase systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((HoverOverBase)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HoverOverBase___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((HoverOverBase)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HoverOverBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((HoverOverBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HoverOverBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((HoverOverBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HoverOverBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((HoverOverBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HtmlHoverOver___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HtmlHoverOver___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HtmlHoverOver___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HtmlHoverOver___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HtmlHoverOver___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
