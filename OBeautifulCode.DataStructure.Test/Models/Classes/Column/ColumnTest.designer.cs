...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Column> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Column>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Column>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Column>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Column>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.Column: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, ValueFormat = {systemUnderTest.ValueFormat?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Column> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Column>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<Column> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Column>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Column>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Column>
                        {
                            SystemUnderTest = new Column(
                                                      referenceObject.Id,
        ...
        private static readonly DeepCloneWithTestScenarios<Column> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Column>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Column>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Column>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<Column>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Column>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Column>().ThatIs(_ => !systemUnderTest.Format.IsEqualTo(_.Format));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Column>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Column>().ThatIs(_ => !systemUnderTest.ValueFormat.IsEqualTo(_.ValueFormat));
        ...
        private static readonly Column ReferenceObjectForEquatableTestScenarios = A.Dummy<Column>();

        private static readonly EquatableTestScenarios<Column> EquatableTestScenarios = new EquatableTestScenarios<Column>()
            .AddScenario(() =>
                new EquatableTestScenario<Column>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Column[]
                    {
                        new Column(
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Column[]
                    {
                        new Column(
                                A.Dummy<Column>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Format,
                                ReferenceObjectForEquatableTestScenarios.ValueFormat),
                        new Column(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<Column>().Whose(_ => !_.Format.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Format)).Format,
                                ReferenceObjectForEquatableTestScenarios.ValueFormat),
                        new Column(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Format,
                                A.Dummy<Column>().Whose(_ => !_.ValueFormat.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ValueFormat)).ValueFormat),
                    },
        ...
        private static readonly ValidModelTestScenarios<Column> ValidModelTestScenarios = new ValidModelTestScenarios<Column>()
            .AddScenario(() =>
                new ValidModelTestScenario<Column>
                {
                    Name = "a dummy Column should be valid",
                    SystemUnderTest = A.Dummy<Column>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void Column___Should_implement_IModel_of_Column___When_reflecting()
            {
                // Arrange
                var type = typeof(Column);

                var expectedModelMethods = typeof(IModel<Column>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Column>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Column___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Column);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Column)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Format", "ValueFormat" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Column)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Column).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                Column systemUnderTest1 = null;
                Column systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Column___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Column___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Column___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Column___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Column___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
