...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TableColumns> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TableColumns>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TableColumns>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableColumns>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TableColumns>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.TableColumns: Columns = {systemUnderTest.Columns?.ToString() ?? "<null>"}, ColumnsFormat = {systemUnderTest.ColumnsFormat?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TableColumns> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TableColumns>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TableColumns> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TableColumns>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableColumns>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableColumns>
                        {
                            SystemUnderTest = new TableColumns(
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableColumns>
                {
                    Name = "ColumnsFormat should return same 'columnsFormat' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableColumns>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TableColumns>
                        {
                            SystemUnderTest = new TableColumns(
                                                      referenceObject.Columns,
                                                      referenceObject.ColumnsFormat),
                            ExpectedPropertyValue = referenceObject.ColumnsFormat,
                        };

                        return result;
                    },
                    PropertyName = "ColumnsFormat",
                });

        private static readonly DeepCloneWithTestScenarios<TableColumns> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TableColumns>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableColumns>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableColumns>().ThatIs(_ => !systemUnderTest.Columns.IsEqualTo(_.Columns));

                        var result = new SystemUnderTestDeepCloneWithValue<TableColumns>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableColumns>
                {
                    Name = "DeepCloneWithColumnsFormat should deep clone object and replace ColumnsFormat with the provided columnsFormat",
                    WithPropertyName = "ColumnsFormat",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableColumns>();

                        var referenceObject = A.Dummy<TableColumns>().ThatIs(_ => !systemUnderTest.ColumnsFormat.IsEqualTo(_.ColumnsFormat));

                        var result = new SystemUnderTestDeepCloneWithValue<TableColumns>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ColumnsFormat,
                        };
        ...
        private static readonly TableColumns ReferenceObjectForEquatableTestScenarios = A.Dummy<TableColumns>();

        private static readonly EquatableTestScenarios<TableColumns> EquatableTestScenarios = new EquatableTestScenarios<TableColumns>()
            .AddScenario(() =>
                new EquatableTestScenario<TableColumns>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TableColumns[]
                    {
                        new TableColumns(
                                ReferenceObjectForEquatableTestScenarios.Columns,
                                ReferenceObjectForEquatableTestScenarios.ColumnsFormat),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new TableColumns[]
                    {
                        new TableColumns(
                                A.Dummy<TableColumns>().Whose(_ => !_.Columns.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Columns)).Columns,
                                ReferenceObjectForEquatableTestScenarios.ColumnsFormat),
                        new TableColumns(
                                ReferenceObjectForEquatableTestScenarios.Columns,
                                A.Dummy<TableColumns>().Whose(_ => !_.ColumnsFormat.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ColumnsFormat)).ColumnsFormat),
                    },
        ...
        private static readonly ValidModelTestScenarios<TableColumns> ValidModelTestScenarios = new ValidModelTestScenarios<TableColumns>()
            .AddScenario(() =>
                new ValidModelTestScenario<TableColumns>
                {
                    Name = "a dummy TableColumns should be valid",
                    SystemUnderTest = A.Dummy<TableColumns>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void TableColumns___Should_implement_IModel_of_TableColumns___When_reflecting()
            {
                // Arrange
                var type = typeof(TableColumns);

                var expectedModelMethods = typeof(IModel<TableColumns>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TableColumns>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TableColumns___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TableColumns);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TableColumns)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ColumnsFormat == null)
                {
                    actual.ColumnsFormat.AsTest().Must().BeNull();
                }
                else if (!actual.ColumnsFormat.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ColumnsFormat.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ColumnsFormat);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Columns", "ColumnsFormat" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TableColumns)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TableColumns).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TableColumns>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                TableColumns systemUnderTest1 = null;
                TableColumns systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TableColumns systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableColumns___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableColumns___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableColumns___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableColumns___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableColumns___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
