...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DataRows> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DataRows>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DataRows>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DataRows>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DataRows>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.DataRows: Rows = {systemUnderTest.Rows?.ToString() ?? "<null>"}, Format = {systemUnderTest.Format?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DataRows> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DataRows>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DataRows> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DataRows>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DataRows>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<DataRows>
                        {
                            SystemUnderTest = new DataRows(
        ...
        private static readonly DeepCloneWithTestScenarios<DataRows> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DataRows>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DataRows>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DataRows>().ThatIs(_ => !systemUnderTest.Rows.IsEqualTo(_.Rows));

                        var result = new SystemUnderTestDeepCloneWithValue<DataRows>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DataRows>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DataRows>().ThatIs(_ => !systemUnderTest.Format.IsEqualTo(_.Format));
        ...
        private static readonly DataRows ReferenceObjectForEquatableTestScenarios = A.Dummy<DataRows>();

        private static readonly EquatableTestScenarios<DataRows> EquatableTestScenarios = new EquatableTestScenarios<DataRows>()
            .AddScenario(() =>
                new EquatableTestScenario<DataRows>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DataRows[]
                    {
                        new DataRows(
                                ReferenceObjectForEquatableTestScenarios.Rows,
                                ReferenceObjectForEquatableTestScenarios.Format),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DataRows[]
                    {
                        new DataRows(
                                A.Dummy<DataRows>().Whose(_ => !_.Rows.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Rows)).Rows,
                                ReferenceObjectForEquatableTestScenarios.Format),
                        new DataRows(
                                ReferenceObjectForEquatableTestScenarios.Rows,
                                A.Dummy<DataRows>().Whose(_ => !_.Format.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Format)).Format),
                    },
        ...
        private static readonly ValidModelTestScenarios<DataRows> ValidModelTestScenarios = new ValidModelTestScenarios<DataRows>()
            .AddScenario(() =>
                new ValidModelTestScenario<DataRows>
                {
                    Name = "a dummy DataRows should be valid",
                    SystemUnderTest = A.Dummy<DataRows>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void DataRows___Should_implement_IModel_of_DataRows___When_reflecting()
            {
                // Arrange
                var type = typeof(DataRows);

                var expectedModelMethods = typeof(IModel<DataRows>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DataRows>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DataRows___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DataRows);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DataRows)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DataRows)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DataRows).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                DataRows systemUnderTest1 = null;
                DataRows systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DataRows___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DataRows___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DataRows___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DataRows___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DataRows___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
