...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HeaderRows> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HeaderRows>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HeaderRows>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HeaderRows>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HeaderRows>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.HeaderRows: Rows = {systemUnderTest.Rows?.ToString() ?? "<null>"}, Format = {systemUnderTest.Format?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HeaderRows> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HeaderRows>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HeaderRows> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HeaderRows>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HeaderRows>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<HeaderRows>
                        {
                            SystemUnderTest = new HeaderRows(
        ...
        private static readonly DeepCloneWithTestScenarios<HeaderRows> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HeaderRows>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HeaderRows>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HeaderRows>().ThatIs(_ => !systemUnderTest.Rows.IsEqualTo(_.Rows));

                        var result = new SystemUnderTestDeepCloneWithValue<HeaderRows>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HeaderRows>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HeaderRows>().ThatIs(_ => !systemUnderTest.Format.IsEqualTo(_.Format));
        ...
        private static readonly HeaderRows ReferenceObjectForEquatableTestScenarios = A.Dummy<HeaderRows>();

        private static readonly EquatableTestScenarios<HeaderRows> EquatableTestScenarios = new EquatableTestScenarios<HeaderRows>()
            .AddScenario(() =>
                new EquatableTestScenario<HeaderRows>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HeaderRows[]
                    {
                        new HeaderRows(
                                ReferenceObjectForEquatableTestScenarios.Rows,
                                ReferenceObjectForEquatableTestScenarios.Format),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HeaderRows[]
                    {
                        new HeaderRows(
                                A.Dummy<HeaderRows>().Whose(_ => !_.Rows.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Rows)).Rows,
                                ReferenceObjectForEquatableTestScenarios.Format),
                        new HeaderRows(
                                ReferenceObjectForEquatableTestScenarios.Rows,
                                A.Dummy<HeaderRows>().Whose(_ => !_.Format.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Format)).Format),
                    },
        ...
        private static readonly ValidModelTestScenarios<HeaderRows> ValidModelTestScenarios = new ValidModelTestScenarios<HeaderRows>()
            .AddScenario(() =>
                new ValidModelTestScenario<HeaderRows>
                {
                    Name = "a dummy HeaderRows should be valid",
                    SystemUnderTest = A.Dummy<HeaderRows>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void HeaderRows___Should_implement_IModel_of_HeaderRows___When_reflecting()
            {
                // Arrange
                var type = typeof(HeaderRows);

                var expectedModelMethods = typeof(IModel<HeaderRows>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HeaderRows>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HeaderRows___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HeaderRows);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HeaderRows)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Rows", "Format" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HeaderRows)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HeaderRows).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HeaderRows>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HeaderRows systemUnderTest1 = null;
                HeaderRows systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HeaderRows systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HeaderRows___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HeaderRows___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HeaderRows___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HeaderRows___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HeaderRows___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
