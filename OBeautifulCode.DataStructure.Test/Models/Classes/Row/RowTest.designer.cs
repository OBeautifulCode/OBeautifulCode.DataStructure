...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Row> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Row>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Row>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<Row>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.Row: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Cells = {systemUnderTest.Cells?.ToString() ?? "<null>"}, Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, ChildRows = {systemUnderTest.ChildRows?.ToString() ?? "<null>"}, ExpandedSummaryRow = {systemUnderTest.ExpandedSummaryRow?.ToString() ?? "<null>"}, CollapsedSummaryRow = {systemUnderTest.CollapsedSummaryRow?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Row> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Row>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Row>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'childRows' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "childRows", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Row>
                {
                    Name = "constructor should throw ArgumentException when parameter 'childRows' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "childRows", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Row>
                {
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Row>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'expandedSummaryRow' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "expandedSummaryRow", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Row>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'collapsedSummaryRow' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "collapsedSummaryRow", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<Row> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Row>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Row>
                {
                    Name = "ChildRows should return same 'childRows' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Row>
                        {
                            SystemUnderTest = new Row(
                                                      ...
                                                      referenceObject.ExpandedSummaryRow,
                                                      referenceObject.CollapsedSummaryRow),
                            ExpectedPropertyValue = referenceObject.ChildRows,
                        };

                        return result;
                    },
                    PropertyName = "ChildRows",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Row>
                {
                    Name = "ExpandedSummaryRow should return same 'expandedSummaryRow' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Row>
                        {
                            SystemUnderTest = new Row(
                                                      ...
                                                      referenceObject.ExpandedSummaryRow,
                                                      referenceObject.CollapsedSummaryRow),
                            ExpectedPropertyValue = referenceObject.ExpandedSummaryRow,
                        };

                        return result;
                    },
                    PropertyName = "ExpandedSummaryRow",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Row>
                {
                    Name = "CollapsedSummaryRow should return same 'collapsedSummaryRow' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Row>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Row>
                        {
                            SystemUnderTest = new Row(
                                                      ...
                                                      referenceObject.ExpandedSummaryRow,
                                                      referenceObject.CollapsedSummaryRow),
                            ExpectedPropertyValue = referenceObject.CollapsedSummaryRow,
                        };

                        return result;
                    },
                    PropertyName = "CollapsedSummaryRow",
                });

        private static readonly DeepCloneWithTestScenarios<Row> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Row>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Row>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Row>().ThatIs(_ => !systemUnderTest.ExpandedSummaryRow.IsEqualTo(_.ExpandedSummaryRow));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Row>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Row>().ThatIs(_ => !systemUnderTest.CollapsedSummaryRow.IsEqualTo(_.CollapsedSummaryRow));
        ...
        private static readonly Row ReferenceObjectForEquatableTestScenarios = A.Dummy<Row>();

        private static readonly EquatableTestScenarios<Row> EquatableTestScenarios = new EquatableTestScenarios<Row>()
            .AddScenario(() =>
                new EquatableTestScenario<Row>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Row[]
                    {
                        ...
                        new Row(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ChildRows,
                                ReferenceObjectForEquatableTestScenarios.ExpandedSummaryRow,
                                A.Dummy<Row>().Whose(_ => !_.CollapsedSummaryRow.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CollapsedSummaryRow)).CollapsedSummaryRow),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Row___Should_implement_IModel_of_Row___When_reflecting()
            {
                // Arrange
                var type = typeof(Row);

                var expectedModelMethods = typeof(IModel<Row>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Row>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Row___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Row);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Row)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ChildRows == null)
                {
                    actual.ChildRows.AsTest().Must().BeNull();
                }
                else if (!actual.ChildRows.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ChildRows.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ChildRows);
                }

                if (systemUnderTest.ExpandedSummaryRow == null)
                {
                    actual.ExpandedSummaryRow.AsTest().Must().BeNull();
                }
                else if (!actual.ExpandedSummaryRow.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ExpandedSummaryRow.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ExpandedSummaryRow);
                }

                if (systemUnderTest.CollapsedSummaryRow == null)
                {
                    actual.CollapsedSummaryRow.AsTest().Must().BeNull();
                }
                else if (!actual.CollapsedSummaryRow.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.CollapsedSummaryRow.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CollapsedSummaryRow);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Id", "Cells", "Format", "ChildRows", "ExpandedSummaryRow", "CollapsedSummaryRow" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Row)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Row).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Row systemUnderTest1 = null;
                Row systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RowBase___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    RowBase systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((RowBase)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RowBase___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((RowBase)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RowBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((RowBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RowBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((RowBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RowBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((RowBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Row___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Row___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Row___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Row___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Row___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
