...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TableRows> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TableRows>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TableRows>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TableRows> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TableRows>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableRows>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'headerRows' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "headerRows", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TableRows>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'dataRows' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableRows>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TableRows> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TableRows>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableRows>
                {
                    Name = "HeaderRows should return same 'headerRows' parameter passed to constructor when getting",
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TableRows>
                {
                    Name = "DataRows should return same 'dataRows' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TableRows>();
        ...
        private static readonly DeepCloneWithTestScenarios<TableRows> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TableRows>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableRows>
                {
                    Name = "DeepCloneWithHeaderRows should deep clone object and replace HeaderRows with the provided headerRows",
                    WithPropertyName = "HeaderRows",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableRows>();

                        var referenceObject = A.Dummy<TableRows>().ThatIs(_ => !systemUnderTest.HeaderRows.IsEqualTo(_.HeaderRows));

                        var result = new SystemUnderTestDeepCloneWithValue<TableRows>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.HeaderRows,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableRows>
                {
                    Name = "DeepCloneWithDataRows should deep clone object and replace DataRows with the provided dataRows",
                    WithPropertyName = "DataRows",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TableRows>();

                        var referenceObject = A.Dummy<TableRows>().ThatIs(_ => !systemUnderTest.DataRows.IsEqualTo(_.DataRows));

                        var result = new SystemUnderTestDeepCloneWithValue<TableRows>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.DataRows,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TableRows>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TableRows>().ThatIs(_ => !systemUnderTest.RowsFormat.IsEqualTo(_.RowsFormat));
        ...
        private static readonly TableRows ReferenceObjectForEquatableTestScenarios = A.Dummy<TableRows>();

        private static readonly EquatableTestScenarios<TableRows> EquatableTestScenarios = new EquatableTestScenarios<TableRows>()
            .AddScenario(() =>
                new EquatableTestScenario<TableRows>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new TableRows[]
                    {
                        new TableRows(
        ...
        public static class Structural
        {
            ...
            public static void TableRows___Should_implement_IModel_of_TableRows___When_reflecting()
            {
                // Arrange
                var type = typeof(TableRows);

                var expectedModelMethods = typeof(IModel<TableRows>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TableRows>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TableRows___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TableRows);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TableRows)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.HeaderRows == null)
                {
                    actual.HeaderRows.AsTest().Must().BeNull();
                }
                else if (!actual.HeaderRows.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.HeaderRows.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.HeaderRows);
                }

                if (systemUnderTest.DataRows == null)
                {
                    actual.DataRows.AsTest().Must().BeNull();
                }
                else if (!actual.DataRows.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TableRows)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TableRows).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TableRows>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                TableRows systemUnderTest1 = null;
                TableRows systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TableRows systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRows___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRows___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRows___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRows___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TableRows___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
