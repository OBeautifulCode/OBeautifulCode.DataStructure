...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly CellOpExecutionEventBase ReferenceObjectForEquatableTestScenarios = A.Dummy<CellOpExecutionEventBase>();

        private static readonly EquatableTestScenarios<CellOpExecutionEventBase> EquatableTestScenarios = new EquatableTestScenarios<CellOpExecutionEventBase>()
            .AddScenario(() =>
                new EquatableTestScenario<CellOpExecutionEventBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellOpExecutionEventBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CellOpExecutionEventBase[]
                    {
                        ...
                        // (CellOpExecutionEventBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<CellOpExecutionEventBase>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithDetails(A.Dummy<CellOpExecutionEventBase>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new CellOpExecutionEventBase[]
                    {
                        A.Dummy<CellOpExecutionEventBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CellOpExecutionEventBase___Should_implement_IModel_of_CellOpExecutionEventBase___When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionEventBase);

                var expectedModelMethods = typeof(IModel<CellOpExecutionEventBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellOpExecutionEventBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellOpExecutionEventBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionEventBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<CellOpExecutionEventBase>();

                // Act
                var actual = (CellOpExecutionEventBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellOpExecutionEventBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CellOpExecutionEventBase systemUnderTest1 = null;
                CellOpExecutionEventBase systemUnderTest2 = null;
