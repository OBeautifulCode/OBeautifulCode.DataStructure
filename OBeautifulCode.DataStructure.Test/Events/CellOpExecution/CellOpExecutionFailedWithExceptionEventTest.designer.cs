...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellOpExecutionFailedWithExceptionEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellOpExecutionFailedWithExceptionEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CellOpExecutionFailedWithExceptionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellOpExecutionFailedWithExceptionEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CellOpExecutionFailedWithExceptionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.CellOpExecutionFailedWithExceptionEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CellOpExecutionFailedWithExceptionEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellOpExecutionFailedWithExceptionEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellOpExecutionFailedWithExceptionEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithExceptionEvent>();

                        var result = new CellOpExecutionFailedWithExceptionEvent(
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CellOpExecutionFailedWithExceptionEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellOpExecutionFailedWithExceptionEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellOpExecutionFailedWithExceptionEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellOpExecutionFailedWithExceptionEvent>
                        {
                            SystemUnderTest = new CellOpExecutionFailedWithExceptionEvent(
                                                      referenceObject.TimestampUtc,
        ...
        private static readonly DeepCloneWithTestScenarios<CellOpExecutionFailedWithExceptionEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellOpExecutionFailedWithExceptionEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionFailedWithExceptionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithExceptionEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CellOpExecutionFailedWithExceptionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionFailedWithExceptionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithExceptionEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CellOpExecutionFailedWithExceptionEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CellOpExecutionFailedWithExceptionEvent>();

        private static readonly EquatableTestScenarios<CellOpExecutionFailedWithExceptionEvent> EquatableTestScenarios = new EquatableTestScenarios<CellOpExecutionFailedWithExceptionEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CellOpExecutionFailedWithExceptionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellOpExecutionFailedWithExceptionEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CellOpExecutionFailedWithExceptionEvent[]
                    {
                        new CellOpExecutionFailedWithExceptionEvent(
                                A.Dummy<CellOpExecutionFailedWithExceptionEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new CellOpExecutionFailedWithExceptionEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<CellOpExecutionFailedWithExceptionEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CellOpExecutionFailedWithExceptionEvent___Should_implement_IModel_of_CellOpExecutionFailedWithExceptionEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionFailedWithExceptionEvent);

                var expectedModelMethods = typeof(IModel<CellOpExecutionFailedWithExceptionEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellOpExecutionFailedWithExceptionEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellOpExecutionFailedWithExceptionEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionFailedWithExceptionEvent);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellOpExecutionFailedWithExceptionEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellOpExecutionFailedWithExceptionEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellOpExecutionFailedWithExceptionEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellOpExecutionFailedWithExceptionEvent>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CellOpExecutionFailedWithExceptionEvent systemUnderTest1 = null;
                CellOpExecutionFailedWithExceptionEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CellOpExecutionFailedWithExceptionEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithExceptionEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithExceptionEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithExceptionEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithExceptionEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithExceptionEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
