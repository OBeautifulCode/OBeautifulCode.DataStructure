...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellOpExecutionDeemedNotApplicableEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellOpExecutionDeemedNotApplicableEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CellOpExecutionDeemedNotApplicableEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.CellOpExecutionDeemedNotApplicableEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CellOpExecutionDeemedNotApplicableEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellOpExecutionDeemedNotApplicableEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'timestampUtc' is not a UTC DateTime (it's Local)",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>();

                        var result = new CellOpExecutionDeemedNotApplicableEvent(
                                             DateTime.Now,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CellOpExecutionDeemedNotApplicableEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellOpExecutionDeemedNotApplicableEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellOpExecutionDeemedNotApplicableEvent>
                        {
                            SystemUnderTest = new CellOpExecutionDeemedNotApplicableEvent(
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<CellOpExecutionDeemedNotApplicableEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellOpExecutionDeemedNotApplicableEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CellOpExecutionDeemedNotApplicableEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CellOpExecutionDeemedNotApplicableEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>();

        private static readonly EquatableTestScenarios<CellOpExecutionDeemedNotApplicableEvent> EquatableTestScenarios = new EquatableTestScenarios<CellOpExecutionDeemedNotApplicableEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellOpExecutionDeemedNotApplicableEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CellOpExecutionDeemedNotApplicableEvent[]
                    {
                        new CellOpExecutionDeemedNotApplicableEvent(
                                A.Dummy<CellOpExecutionDeemedNotApplicableEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new CellOpExecutionDeemedNotApplicableEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<CellOpExecutionDeemedNotApplicableEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<CellOpExecutionDeemedNotApplicableEvent> ValidModelTestScenarios = new ValidModelTestScenarios<CellOpExecutionDeemedNotApplicableEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<CellOpExecutionDeemedNotApplicableEvent>
                {
                    Name = "a dummy CellOpExecutionDeemedNotApplicableEvent should be valid",
                    SystemUnderTest = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CellOpExecutionDeemedNotApplicableEvent___Should_implement_IModel_of_CellOpExecutionDeemedNotApplicableEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionDeemedNotApplicableEvent);

                var expectedModelMethods = typeof(IModel<CellOpExecutionDeemedNotApplicableEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellOpExecutionDeemedNotApplicableEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellOpExecutionDeemedNotApplicableEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionDeemedNotApplicableEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellOpExecutionDeemedNotApplicableEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellOpExecutionDeemedNotApplicableEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellOpExecutionDeemedNotApplicableEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellOpExecutionDeemedNotApplicableEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CellOpExecutionDeemedNotApplicableEvent systemUnderTest1 = null;
                CellOpExecutionDeemedNotApplicableEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CellOpExecutionDeemedNotApplicableEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionDeemedNotApplicableEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionDeemedNotApplicableEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionDeemedNotApplicableEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionDeemedNotApplicableEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionDeemedNotApplicableEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
