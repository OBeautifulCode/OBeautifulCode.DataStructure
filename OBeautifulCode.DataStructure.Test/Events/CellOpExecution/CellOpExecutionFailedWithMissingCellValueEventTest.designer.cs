...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CellOpExecutionFailedWithMissingCellValueEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.CellOpExecutionFailedWithMissingCellValueEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, CellLocator = {systemUnderTest.CellLocator?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'cellLocator' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>();

                        var result = new CellOpExecutionFailedWithMissingCellValueEvent(
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellOpExecutionFailedWithMissingCellValueEvent>
                        {
                            SystemUnderTest = new CellOpExecutionFailedWithMissingCellValueEvent(
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.CellLocator,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CellOpExecutionFailedWithMissingCellValueEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>().ThatIs(_ => !systemUnderTest.CellLocator.IsEqualTo(_.CellLocator));
        ...
        private static readonly CellOpExecutionFailedWithMissingCellValueEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>();

        private static readonly EquatableTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent> EquatableTestScenarios = new EquatableTestScenarios<CellOpExecutionFailedWithMissingCellValueEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CellOpExecutionFailedWithMissingCellValueEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellOpExecutionFailedWithMissingCellValueEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CellOpExecutionFailedWithMissingCellValueEvent[]
                    {
                        new CellOpExecutionFailedWithMissingCellValueEvent(
                                A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.CellLocator,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new CellOpExecutionFailedWithMissingCellValueEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.CellLocator,
                                A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                        new CellOpExecutionFailedWithMissingCellValueEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>().Whose(_ => !_.CellLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CellLocator)).CellLocator,
                                ReferenceObjectForEquatableTestScenarios.Details),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CellOpExecutionFailedWithMissingCellValueEvent___Should_implement_IModel_of_CellOpExecutionFailedWithMissingCellValueEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionFailedWithMissingCellValueEvent);

                var expectedModelMethods = typeof(IModel<CellOpExecutionFailedWithMissingCellValueEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellOpExecutionFailedWithMissingCellValueEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellOpExecutionFailedWithMissingCellValueEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionFailedWithMissingCellValueEvent);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellOpExecutionFailedWithMissingCellValueEvent)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "TimestampUtc", "Details", "CellLocator" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellOpExecutionFailedWithMissingCellValueEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellOpExecutionFailedWithMissingCellValueEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellOpExecutionFailedWithMissingCellValueEvent>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CellOpExecutionFailedWithMissingCellValueEvent systemUnderTest1 = null;
                CellOpExecutionFailedWithMissingCellValueEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CellOpExecutionFailedWithMissingCellValueEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithMissingCellValueEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithMissingCellValueEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithMissingCellValueEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithMissingCellValueEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionFailedWithMissingCellValueEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
