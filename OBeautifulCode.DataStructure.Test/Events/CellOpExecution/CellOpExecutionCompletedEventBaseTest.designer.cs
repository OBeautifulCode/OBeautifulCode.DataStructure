...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly CellOpExecutionCompletedEventBase ReferenceObjectForEquatableTestScenarios = A.Dummy<CellOpExecutionCompletedEventBase>();

        private static readonly EquatableTestScenarios<CellOpExecutionCompletedEventBase> EquatableTestScenarios = new EquatableTestScenarios<CellOpExecutionCompletedEventBase>()
            .AddScenario(() =>
                new EquatableTestScenario<CellOpExecutionCompletedEventBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellOpExecutionCompletedEventBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CellOpExecutionCompletedEventBase[]
                    {
                        ...
                        // (CellOpExecutionCompletedEventBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<CellOpExecutionCompletedEventBase>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // (CellOpExecutionCompletedEventBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithDetails(A.Dummy<CellOpExecutionCompletedEventBase>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CellOpExecutionCompletedEventBase___Should_implement_IModel_of_CellOpExecutionCompletedEventBase___When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionCompletedEventBase);

                var expectedModelMethods = typeof(IModel<CellOpExecutionCompletedEventBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellOpExecutionCompletedEventBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellOpExecutionCompletedEventBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionCompletedEventBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<CellOpExecutionCompletedEventBase>();

                // Act
                var actual = (CellOpExecutionCompletedEventBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellOpExecutionCompletedEventBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CellOpExecutionCompletedEventBase systemUnderTest1 = null;
                CellOpExecutionCompletedEventBase systemUnderTest2 = null;
