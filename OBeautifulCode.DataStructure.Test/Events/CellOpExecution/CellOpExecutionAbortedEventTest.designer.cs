...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellOpExecutionAbortedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellOpExecutionAbortedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CellOpExecutionAbortedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellOpExecutionAbortedEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CellOpExecutionAbortedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.CellOpExecutionAbortedEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CellOpExecutionAbortedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellOpExecutionAbortedEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellOpExecutionAbortedEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'timestampUtc' is not a UTC DateTime (it's Local)",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellOpExecutionAbortedEvent>();

                        var result = new CellOpExecutionAbortedEvent(
                                             DateTime.Now,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CellOpExecutionAbortedEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellOpExecutionAbortedEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellOpExecutionAbortedEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellOpExecutionAbortedEvent>
                        {
                            SystemUnderTest = new CellOpExecutionAbortedEvent(
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<CellOpExecutionAbortedEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellOpExecutionAbortedEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionAbortedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionAbortedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CellOpExecutionAbortedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellOpExecutionAbortedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellOpExecutionAbortedEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CellOpExecutionAbortedEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CellOpExecutionAbortedEvent>();

        private static readonly EquatableTestScenarios<CellOpExecutionAbortedEvent> EquatableTestScenarios = new EquatableTestScenarios<CellOpExecutionAbortedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CellOpExecutionAbortedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellOpExecutionAbortedEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CellOpExecutionAbortedEvent[]
                    {
                        new CellOpExecutionAbortedEvent(
                                A.Dummy<CellOpExecutionAbortedEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new CellOpExecutionAbortedEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<CellOpExecutionAbortedEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<CellOpExecutionAbortedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<CellOpExecutionAbortedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<CellOpExecutionAbortedEvent>
                {
                    Name = "a dummy CellOpExecutionAbortedEvent should be valid",
                    SystemUnderTest = A.Dummy<CellOpExecutionAbortedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CellOpExecutionAbortedEvent___Should_implement_IModel_of_CellOpExecutionAbortedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionAbortedEvent);

                var expectedModelMethods = typeof(IModel<CellOpExecutionAbortedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellOpExecutionAbortedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellOpExecutionAbortedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellOpExecutionAbortedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellOpExecutionAbortedEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellOpExecutionAbortedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellOpExecutionAbortedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellOpExecutionAbortedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CellOpExecutionAbortedEvent systemUnderTest1 = null;
                CellOpExecutionAbortedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CellOpExecutionAbortedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionAbortedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionAbortedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionAbortedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionAbortedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellOpExecutionAbortedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
