...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class CellOpExecutionClearedEventTest
    {
        ...
        private static readonly ValidModelTestScenarios<CellOpExecutionClearedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<CellOpExecutionClearedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<CellOpExecutionClearedEvent>
                {
                    Name = "a dummy CellOpExecutionClearedEvent should be valid",
                    SystemUnderTest = A.Dummy<CellOpExecutionClearedEvent>(),
                });
