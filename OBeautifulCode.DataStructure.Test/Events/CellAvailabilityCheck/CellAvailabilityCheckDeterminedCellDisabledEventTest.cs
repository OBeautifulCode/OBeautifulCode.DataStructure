// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CellAvailabilityCheckDeterminedCellDisabledEventTest.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class CellAvailabilityCheckDeterminedCellDisabledEventTest
    {
        [SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode", Justification = ObcSuppressBecause.CA1505_AvoidUnmaintainableCode_DisagreeWithAssessment)]
        [SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline", Justification = ObcSuppressBecause.CA1810_InitializeReferenceTypeStaticFieldsInline_FieldsDeclaredInCodeGeneratedPartialTestClass)]
        static CellAvailabilityCheckDeterminedCellDisabledEventTest()
        {
            ConstructorArgumentValidationTestScenarios
                .RemoveAllScenarios()
                .AddScenario(() =>
                    new ConstructorArgumentValidationTestScenario<CellAvailabilityCheckDeterminedCellDisabledEvent>
                    {
                        Name = "constructor should throw ArgumentException when parameter 'timestampUtc' is not a UTC DateTime (it's Local)",
                        ConstructionFunc = () =>
                        {
                            var referenceObject = A.Dummy<CellAvailabilityCheckDeterminedCellDisabledEvent>();

                            var result = new CellAvailabilityCheckDeterminedCellDisabledEvent(
