...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellAvailabilityCheckFailedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellAvailabilityCheckFailedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellAvailabilityCheckFailedEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CellAvailabilityCheckFailedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.CellAvailabilityCheckFailedEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CellAvailabilityCheckFailedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellAvailabilityCheckFailedEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'timestampUtc' is not a UTC DateTime (it's Local)",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellAvailabilityCheckFailedEvent>();

                        var result = new CellAvailabilityCheckFailedEvent(
                                             DateTime.Now,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CellAvailabilityCheckFailedEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellAvailabilityCheckFailedEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellAvailabilityCheckFailedEvent>
                        {
                            SystemUnderTest = new CellAvailabilityCheckFailedEvent(
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<CellAvailabilityCheckFailedEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellAvailabilityCheckFailedEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellAvailabilityCheckFailedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CellAvailabilityCheckFailedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellAvailabilityCheckFailedEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CellAvailabilityCheckFailedEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CellAvailabilityCheckFailedEvent>();

        private static readonly EquatableTestScenarios<CellAvailabilityCheckFailedEvent> EquatableTestScenarios = new EquatableTestScenarios<CellAvailabilityCheckFailedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellAvailabilityCheckFailedEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CellAvailabilityCheckFailedEvent[]
                    {
                        new CellAvailabilityCheckFailedEvent(
                                A.Dummy<CellAvailabilityCheckFailedEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new CellAvailabilityCheckFailedEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<CellAvailabilityCheckFailedEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<CellAvailabilityCheckFailedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<CellAvailabilityCheckFailedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<CellAvailabilityCheckFailedEvent>
                {
                    Name = "a dummy CellAvailabilityCheckFailedEvent should be valid",
                    SystemUnderTest = A.Dummy<CellAvailabilityCheckFailedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CellAvailabilityCheckFailedEvent___Should_implement_IModel_of_CellAvailabilityCheckFailedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CellAvailabilityCheckFailedEvent);

                var expectedModelMethods = typeof(IModel<CellAvailabilityCheckFailedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellAvailabilityCheckFailedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellAvailabilityCheckFailedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellAvailabilityCheckFailedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellAvailabilityCheckFailedEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellAvailabilityCheckFailedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellAvailabilityCheckFailedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellAvailabilityCheckFailedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CellAvailabilityCheckFailedEvent systemUnderTest1 = null;
                CellAvailabilityCheckFailedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CellAvailabilityCheckFailedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellAvailabilityCheckFailedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellAvailabilityCheckFailedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellAvailabilityCheckFailedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellAvailabilityCheckFailedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellAvailabilityCheckFailedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
