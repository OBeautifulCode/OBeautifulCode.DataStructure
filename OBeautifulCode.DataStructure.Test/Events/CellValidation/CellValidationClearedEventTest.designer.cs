...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellValidationClearedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellValidationClearedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CellValidationClearedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellValidationClearedEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CellValidationClearedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.CellValidationClearedEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CellValidationClearedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellValidationClearedEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellValidationClearedEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'timestampUtc' is not a UTC DateTime (it's Local)",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellValidationClearedEvent>();

                        var result = new CellValidationClearedEvent(
                                             DateTime.Now,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CellValidationClearedEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellValidationClearedEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellValidationClearedEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellValidationClearedEvent>
                        {
                            SystemUnderTest = new CellValidationClearedEvent(
        ...
        private static readonly DeepCloneWithTestScenarios<CellValidationClearedEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellValidationClearedEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellValidationClearedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellValidationClearedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CellValidationClearedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellValidationClearedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CellValidationClearedEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CellValidationClearedEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CellValidationClearedEvent>();

        private static readonly EquatableTestScenarios<CellValidationClearedEvent> EquatableTestScenarios = new EquatableTestScenarios<CellValidationClearedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CellValidationClearedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellValidationClearedEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CellValidationClearedEvent[]
                    {
                        new CellValidationClearedEvent(
                                A.Dummy<CellValidationClearedEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new CellValidationClearedEvent(
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<CellValidationClearedEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<CellValidationClearedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<CellValidationClearedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<CellValidationClearedEvent>
                {
                    Name = "a dummy CellValidationClearedEvent should be valid",
                    SystemUnderTest = A.Dummy<CellValidationClearedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CellValidationClearedEvent___Should_implement_IModel_of_CellValidationClearedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CellValidationClearedEvent);

                var expectedModelMethods = typeof(IModel<CellValidationClearedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellValidationClearedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellValidationClearedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellValidationClearedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellValidationClearedEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellValidationClearedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellValidationClearedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CellValidationClearedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CellValidationClearedEvent systemUnderTest1 = null;
                CellValidationClearedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CellValidationClearedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellValidationClearedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellValidationClearedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellValidationClearedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellValidationClearedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellValidationClearedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
