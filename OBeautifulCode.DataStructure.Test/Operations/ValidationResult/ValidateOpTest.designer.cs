...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ValidateOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ValidateOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ValidateOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ValidateOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ValidateOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.ValidateOp: ValidationChain = {systemUnderTest.ValidationChain?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ValidateOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ValidateOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ValidateOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'validationChain' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "validationChain", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<ValidateOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ValidateOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ValidateOp>
                {
                    Name = "ValidationChain should return same 'validationChain' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ValidateOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<ValidateOp>
                        {
                            SystemUnderTest = new ValidateOp(
                                                      referenceObject.ValidationChain),
                            ExpectedPropertyValue = referenceObject.ValidationChain,
                        };

                        return result;
                    },
                    PropertyName = "ValidationChain",
                });

        private static readonly DeepCloneWithTestScenarios<ValidateOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ValidateOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ValidateOp>
                {
                    Name = "DeepCloneWithValidationChain should deep clone object and replace ValidationChain with the provided validationChain",
                    WithPropertyName = "ValidationChain",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ValidateOp>();

                        var referenceObject = A.Dummy<ValidateOp>().ThatIs(_ => !systemUnderTest.ValidationChain.IsEqualTo(_.ValidationChain));

                        var result = new SystemUnderTestDeepCloneWithValue<ValidateOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ValidationChain,
                        };
        ...
        private static readonly ValidateOp ReferenceObjectForEquatableTestScenarios = A.Dummy<ValidateOp>();

        private static readonly EquatableTestScenarios<ValidateOp> EquatableTestScenarios = new EquatableTestScenarios<ValidateOp>()
            .AddScenario(() =>
                new EquatableTestScenario<ValidateOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ValidateOp[]
                    {
                        new ValidateOp(
                                ReferenceObjectForEquatableTestScenarios.ValidationChain),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ValidateOp[]
                    {
                        new ValidateOp(
                                A.Dummy<ValidateOp>().Whose(_ => !_.ValidationChain.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ValidationChain)).ValidationChain),
                    },
        ...
        private static readonly ValidModelTestScenarios<ValidateOp> ValidModelTestScenarios = new ValidModelTestScenarios<ValidateOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ValidateOp>
                {
                    Name = "a dummy ValidateOp should be valid",
                    SystemUnderTest = A.Dummy<ValidateOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ValidateOp___Should_implement_IModel_of_ValidateOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ValidateOp);

                var expectedModelMethods = typeof(IModel<ValidateOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ValidateOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ValidateOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ValidateOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ValidateOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ValidationChain == null)
                {
                    actual.ValidationChain.AsTest().Must().BeNull();
                }
                else if (!actual.ValidationChain.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ValidationChain.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ValidationChain);
                }
            }
            ...
            {
                var propertyNames = new string[] { "ValidationChain" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ValidateOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ValidateOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ValidateOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ValidateOp systemUnderTest1 = null;
                ValidateOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ValidateOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_ValidationResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_ValidationResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_ValidationResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_ValidationResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_ValidationResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidateOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidateOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidateOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidateOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ValidateOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
