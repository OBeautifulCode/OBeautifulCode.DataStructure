...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetConstOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetConstOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetConstOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetConstOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetConstOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.GetConstOp<Version>: Value = {systemUnderTest.Value?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetConstOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetConstOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetConstOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'value' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetConstOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetConstOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetConstOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetConstOp<Version>>
                {
                    Name = "Value should return same 'value' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetConstOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetConstOp<Version>>
                        {
                            SystemUnderTest = new GetConstOp<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<GetConstOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetConstOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetConstOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetConstOp<Version>>().ThatIs(_ => !systemUnderTest.Value.IsEqualTo(_.Value));

                        var result = new SystemUnderTestDeepCloneWithValue<GetConstOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetConstOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetConstOp<Version>>();

        private static readonly EquatableTestScenarios<GetConstOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<GetConstOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetConstOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetConstOp<Version>[]
                    {
                        new GetConstOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Value),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetConstOp<Version>[]
                    {
                        new GetConstOp<Version>(
                                A.Dummy<GetConstOp<Version>>().Whose(_ => !_.Value.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Value)).Value),
                    },
        ...
        public static class Structural
        {
            ...
            public static void GetConstOp_of_Version___Should_implement_IModel_of_GetConstOp_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(GetConstOp<Version>);

                var expectedModelMethods = typeof(IModel<GetConstOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetConstOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetConstOp_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetConstOp<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetConstOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetConstOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetConstOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetConstOp<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetConstOp<Version> systemUnderTest1 = null;
                GetConstOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetConstOp<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetConstOp_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetConstOp_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetConstOp_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetConstOp_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetConstOp_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
