...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class SumOpTest
    {
                ...
                new StringRepresentationTestScenario<SumOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<SumOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.SumOp: Statements = {systemUnderTest.Statements?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<SumOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<SumOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SumOp>
                {
                    ...
                    {
                        var result = new SumOp(
                                             new List<IReturningOperation<decimal>>());
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<SumOp>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new SumOp(
                                             new IReturningOperation<decimal>[0].Concat(referenceObject.Statements).Concat(new IReturningOperation<decimal>[] { null }).Concat(referenceObject.Statements).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<SumOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<SumOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<SumOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<SumOp>
                        {
                            SystemUnderTest = new SumOp(
        ...
        private static readonly EquatableTestScenarios<SumOp> EquatableTestScenarios = new EquatableTestScenarios<SumOp>()
            .AddScenario(() =>
                new EquatableTestScenario<SumOp>
                {
                    ...
                    {
                        new SumOp(
                                A.Dummy<SumOp>().Whose(_ => !_.Statements.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statements)).Statements),
                    },
