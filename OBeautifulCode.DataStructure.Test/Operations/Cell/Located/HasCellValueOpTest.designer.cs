...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HasCellValueOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HasCellValueOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HasCellValueOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HasCellValueOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HasCellValueOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.HasCellValueOp: CellLocator = {systemUnderTest.CellLocator?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HasCellValueOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HasCellValueOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HasCellValueOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HasCellValueOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HasCellValueOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HasCellValueOp>
                {
                    Name = "CellLocator should return same 'cellLocator' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HasCellValueOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<HasCellValueOp>
                        {
                            SystemUnderTest = new HasCellValueOp(
        ...
        private static readonly DeepCloneWithTestScenarios<HasCellValueOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HasCellValueOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HasCellValueOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HasCellValueOp>().ThatIs(_ => !systemUnderTest.CellLocator.IsEqualTo(_.CellLocator));

                        var result = new SystemUnderTestDeepCloneWithValue<HasCellValueOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HasCellValueOp ReferenceObjectForEquatableTestScenarios = A.Dummy<HasCellValueOp>();

        private static readonly EquatableTestScenarios<HasCellValueOp> EquatableTestScenarios = new EquatableTestScenarios<HasCellValueOp>()
            .AddScenario(() =>
                new EquatableTestScenario<HasCellValueOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HasCellValueOp[]
                    {
                        new HasCellValueOp(
                                ReferenceObjectForEquatableTestScenarios.CellLocator),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HasCellValueOp[]
                    {
                        new HasCellValueOp(
                                A.Dummy<HasCellValueOp>().Whose(_ => !_.CellLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CellLocator)).CellLocator),
                    },
        ...
        private static readonly ValidModelTestScenarios<HasCellValueOp> ValidModelTestScenarios = new ValidModelTestScenarios<HasCellValueOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<HasCellValueOp>
                {
                    Name = "a dummy HasCellValueOp should be valid",
                    SystemUnderTest = A.Dummy<HasCellValueOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void HasCellValueOp___Should_implement_IModel_of_HasCellValueOp___When_reflecting()
            {
                // Arrange
                var type = typeof(HasCellValueOp);

                var expectedModelMethods = typeof(IModel<HasCellValueOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HasCellValueOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HasCellValueOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HasCellValueOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HasCellValueOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HasCellValueOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HasCellValueOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HasCellValueOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HasCellValueOp systemUnderTest1 = null;
                HasCellValueOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HasCellValueOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_LocatedCellOpBase_of_bool___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    LocatedCellOpBase<bool> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((LocatedCellOpBase<bool>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_LocatedCellOpBase_of_bool___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((LocatedCellOpBase<bool>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_LocatedCellOpBase_of_bool___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((LocatedCellOpBase<bool>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_LocatedCellOpBase_of_bool___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((LocatedCellOpBase<bool>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_LocatedCellOpBase_of_bool___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((LocatedCellOpBase<bool>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HasCellValueOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HasCellValueOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HasCellValueOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HasCellValueOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HasCellValueOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
