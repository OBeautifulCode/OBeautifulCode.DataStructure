...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class ValidateCellIfNecessaryOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<ValidateCellIfNecessaryOp> ValidModelTestScenarios = new ValidModelTestScenarios<ValidateCellIfNecessaryOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ValidateCellIfNecessaryOp>
                {
                    Name = "a dummy ValidateCellIfNecessaryOp should be valid",
                    SystemUnderTest = A.Dummy<ValidateCellIfNecessaryOp>(),
                });
