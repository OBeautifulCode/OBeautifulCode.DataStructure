...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ExecuteOperationCellIfNecessaryOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ExecuteOperationCellIfNecessaryOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.ExecuteOperationCellIfNecessaryOp<Version>: Cell = {systemUnderTest.Cell?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExecuteOperationCellIfNecessaryOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'cell' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new ExecuteOperationCellIfNecessaryOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ExecuteOperationCellIfNecessaryOp<Version>>
                {
                    Name = "Cell should return same 'cell' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<ExecuteOperationCellIfNecessaryOp<Version>>
                        {
                            SystemUnderTest = new ExecuteOperationCellIfNecessaryOp<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExecuteOperationCellIfNecessaryOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>().ThatIs(_ => !systemUnderTest.Cell.IsEqualTo(_.Cell));

                        var result = new SystemUnderTestDeepCloneWithValue<ExecuteOperationCellIfNecessaryOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ExecuteOperationCellIfNecessaryOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>();

        private static readonly EquatableTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<ExecuteOperationCellIfNecessaryOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ExecuteOperationCellIfNecessaryOp<Version>[]
                    {
                        new ExecuteOperationCellIfNecessaryOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Cell),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ExecuteOperationCellIfNecessaryOp<Version>[]
                    {
                        new ExecuteOperationCellIfNecessaryOp<Version>(
                                A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>().Whose(_ => !_.Cell.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Cell)).Cell),
                    },
        ...
        private static readonly ValidModelTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<ExecuteOperationCellIfNecessaryOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<ExecuteOperationCellIfNecessaryOp<Version>>
                {
                    Name = "a dummy ExecuteOperationCellIfNecessaryOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ExecuteOperationCellIfNecessaryOp_of_Version___Should_implement_IModel_of_ExecuteOperationCellIfNecessaryOp_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(ExecuteOperationCellIfNecessaryOp<Version>);

                var expectedModelMethods = typeof(IModel<ExecuteOperationCellIfNecessaryOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ExecuteOperationCellIfNecessaryOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ExecuteOperationCellIfNecessaryOp_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ExecuteOperationCellIfNecessaryOp<Version>);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ExecuteOperationCellIfNecessaryOp<Version>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Cell" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ExecuteOperationCellIfNecessaryOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ExecuteOperationCellIfNecessaryOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ExecuteOperationCellIfNecessaryOp<Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ExecuteOperationCellIfNecessaryOp<Version> systemUnderTest1 = null;
                ExecuteOperationCellIfNecessaryOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ExecuteOperationCellIfNecessaryOp<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteOperationCellIfNecessaryOp_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteOperationCellIfNecessaryOp_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteOperationCellIfNecessaryOp_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteOperationCellIfNecessaryOp_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteOperationCellIfNecessaryOp_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
