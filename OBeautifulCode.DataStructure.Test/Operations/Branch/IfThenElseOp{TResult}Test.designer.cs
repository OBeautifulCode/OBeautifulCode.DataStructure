...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class IfThenElseOpTResultTest
    {
                ...
                new StringRepresentationTestScenario<IfThenElseOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<IfThenElseOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.IfThenElseOp<Version>: Condition = {systemUnderTest.Condition?.ToString() ?? "<null>"}, Statement = {systemUnderTest.Statement?.ToString() ?? "<null>"}, ElseStatement = {systemUnderTest.ElseStatement?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<IfThenElseOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<IfThenElseOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<IfThenElseOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'condition' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<IfThenElseOp<Version>>();

                        var result = new IfThenElseOp<Version>(
                                             null,
                                             referenceObject.Statement,
                                             referenceObject.ElseStatement);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "condition", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<IfThenElseOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'statement' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<IfThenElseOp<Version>>();

                        var result = new IfThenElseOp<Version>(
                                             referenceObject.Condition,
                                             null,
                                             referenceObject.ElseStatement);
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "statement", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<IfThenElseOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'elseStatement' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<IfThenElseOp<Version>>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "elseStatement", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<IfThenElseOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<IfThenElseOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<IfThenElseOp<Version>>
                {
                    Name = "Condition should return same 'condition' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<IfThenElseOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<IfThenElseOp<Version>>
                        {
                            SystemUnderTest = new IfThenElseOp<Version>(
                                                      referenceObject.Condition,
                                                      referenceObject.Statement,
                                                      referenceObject.ElseStatement),
                            ExpectedPropertyValue = referenceObject.Condition,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<IfThenElseOp<Version>>
                {
                    Name = "Statement should return same 'statement' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<IfThenElseOp<Version>>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<IfThenElseOp<Version>>
                        {
                            SystemUnderTest = new IfThenElseOp<Version>(
                                                      ...
                                                      referenceObject.Statement,
                                                      referenceObject.ElseStatement),
                            ExpectedPropertyValue = referenceObject.Statement,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<IfThenElseOp<Version>>
                {
                    Name = "ElseStatement should return same 'elseStatement' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<IfThenElseOp<Version>>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<IfThenElseOp<Version>>
                        {
                            SystemUnderTest = new IfThenElseOp<Version>(
                                                      ...
                                                      referenceObject.Statement,
                                                      referenceObject.ElseStatement),
                            ExpectedPropertyValue = referenceObject.ElseStatement,
                        };

                        return result;
                    },
                    PropertyName = "ElseStatement",
                });
                ...
                new EquatableTestScenario<IfThenElseOp<Version>>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new IfThenElseOp<Version>[]
                    {
                        new IfThenElseOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Condition,
                                ReferenceObjectForEquatableTestScenarios.Statement,
                                ReferenceObjectForEquatableTestScenarios.ElseStatement),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new IfThenElseOp<Version>[]
                    {
                        new IfThenElseOp<Version>(
                                A.Dummy<IfThenElseOp<Version>>().Whose(_ => !_.Condition.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Condition)).Condition,
                                ReferenceObjectForEquatableTestScenarios.Statement,
                                ReferenceObjectForEquatableTestScenarios.ElseStatement),
                        new IfThenElseOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Condition,
                                A.Dummy<IfThenElseOp<Version>>().Whose(_ => !_.Statement.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statement)).Statement,
                                ReferenceObjectForEquatableTestScenarios.ElseStatement),
                        new IfThenElseOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Condition,
                                ReferenceObjectForEquatableTestScenarios.Statement,
                                A.Dummy<IfThenElseOp<Version>>().Whose(_ => !_.ElseStatement.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ElseStatement)).ElseStatement),
                    },
        ...
        public static class Structural
        {
            ...
            public static void IfThenElseOp___Should_implement_IModel_of_IfThenElseOp___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void IfThenElseOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(IfThenElseOp<Version>);
        ...
        public static class Equality
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_IfThenElseOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_IfThenElseOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_IfThenElseOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_IfThenElseOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_IfThenElseOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
