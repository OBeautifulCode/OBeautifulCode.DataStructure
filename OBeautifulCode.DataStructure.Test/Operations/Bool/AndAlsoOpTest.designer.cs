...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class AndAlsoOpTest
    {
                ...
                new StringRepresentationTestScenario<AndAlsoOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<AndAlsoOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.AndAlsoOp: Statements = {systemUnderTest.Statements?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AndAlsoOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AndAlsoOp>
                {
                    ...
                    {
                        var result = new AndAlsoOp(
                                             new List<IReturningOperation<bool>>());
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AndAlsoOp>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new AndAlsoOp(
                                             new IReturningOperation<bool>[0].Concat(referenceObject.Statements).Concat(new IReturningOperation<bool>[] { null }).Concat(referenceObject.Statements).ToList());
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<AndAlsoOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AndAlsoOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<AndAlsoOp>
                        {
                            SystemUnderTest = new AndAlsoOp(
        ...
        private static readonly EquatableTestScenarios<AndAlsoOp> EquatableTestScenarios = new EquatableTestScenarios<AndAlsoOp>()
            .AddScenario(() =>
                new EquatableTestScenario<AndAlsoOp>
                {
                    ...
                    {
                        new AndAlsoOp(
                                A.Dummy<AndAlsoOp>().Whose(_ => !_.Statements.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statements)).Statements),
                    },
