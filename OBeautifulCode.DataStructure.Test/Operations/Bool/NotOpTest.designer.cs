...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class NotOpTest
    {
                ...
                new StringRepresentationTestScenario<NotOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<NotOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.NotOp: Statement = {systemUnderTest.Statement?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NotOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NotOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NotOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NotOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NotOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NotOp>
                {
                    Name = "Statement should return same 'statement' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<NotOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<NotOp>
                        {
                            SystemUnderTest = new NotOp(
        ...
        private static readonly EquatableTestScenarios<NotOp> EquatableTestScenarios = new EquatableTestScenarios<NotOp>()
            .AddScenario(() =>
                new EquatableTestScenario<NotOp>
                {
                    ...
                    {
                        new NotOp(
                                A.Dummy<NotOp>().Whose(_ => !_.Statement.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statement)).Statement),
                    },
