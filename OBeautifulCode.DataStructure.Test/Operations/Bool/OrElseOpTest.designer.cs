...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static partial class OrElseOpTest
    {
                ...
                new StringRepresentationTestScenario<OrElseOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<OrElseOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.DataStructure.OrElseOp: Statements = {systemUnderTest.Statements?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<OrElseOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<OrElseOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<OrElseOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<OrElseOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<OrElseOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<OrElseOp>
                        {
                            SystemUnderTest = new OrElseOp(
        ...
        private static readonly EquatableTestScenarios<OrElseOp> EquatableTestScenarios = new EquatableTestScenarios<OrElseOp>()
            .AddScenario(() =>
                new EquatableTestScenario<OrElseOp>
                {
                    ...
                    {
                        new OrElseOp(
                                A.Dummy<OrElseOp>().Whose(_ => !_.Statements.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Statements)).Statements),
                    },
