        ...
        public DefaultDataStructureDummyFactory()
        {
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () =>
                {
                    ...
                    {
                        typeof(MessageByOpBooleanValidationStep),
                        typeof(MessageContainedBooleanValidationStep),
                        typeof(SimpleBooleanValidationStep)
                    };
                    ...
                    var result = (BooleanValidationStepBase)AD.ummy(randomType);
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () =>
                {
                    ...
                    var result = (CellInputAppliedEventBase)AD.ummy(randomType);
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () =>
                {
                    ...
                    var result = (CellOpExecutionCompletedEventBase)AD.ummy(randomType);
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () =>
                {
                    var availableTypes = new[]
                    {
                        ...
                        typeof(CurrencyCellValueFormat<Version>),
                        typeof(NullNumberCellFormat<Version>),
                        typeof(NumberCellValueFormat<Version>),
                        typeof(PercentCellValueFormat<Version>)
                    };
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new GetAvailabilityOp(
                                 A.Dummy<IReturningOperation<ICellLocator>>()));
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new MessageContainedBooleanValidationStep(
                                 A.Dummy<IReturningOperation<ValidationBoolWithMessage>>(),
                                 A.Dummy<ValidationStepAction>(),
                                 A.Dummy<ValidationStepAction>(),
                                 A.Dummy<string>()));
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new MultiActionButton(
                                 A.Dummy<string>(),
                                 A.Dummy<IReadOnlyList<MultiActionButtonItem>>()));
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () => new ValidationChain(
                                 A.Dummy<IReadOnlyList<ValidationStepBase>>(),
                                 A.Dummy<IReturningOperation<string>>(),
                                 A.Dummy<Validity>()));
            ...
            AutoFixtureBackedDummyFactory.AddDummyCreator(
                () =>
                {
                    ...
                    var result = (ValidationStepBase)AD.ummy(randomType);
