...
namespace OBeautifulCode.DataStructure.Test
{
    ...
    public static class CellNotFoundExceptionTest
    {
        ...
        public static void Message___Should_return_same_message_passed_to_constructor___When_getting()
        {
            ...
            var systemUnderTest1 = new CellNotFoundException(expected, A.Dummy<CellLocatorBase>());
            var systemUnderTest2 = new CellNotFoundException(expected, A.Dummy<Exception>(), A.Dummy<CellLocatorBase>());
        ...
        public static void InnerException___Should_return_same_innerException_passed_to_constructor___When_getting()
        {
            ...
            var systemUnderTest = new CellNotFoundException(A.Dummy<string>(), expected, A.Dummy<CellLocatorBase>());
