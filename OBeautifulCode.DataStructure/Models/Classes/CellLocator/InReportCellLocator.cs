// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InReportCellLocator.cs" company="OBeautifulCode">
...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class InReportCellLocator : CellLocatorBase, IModelViaCodeGen
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InReportCellLocator"/> class.
        /// </summary>
