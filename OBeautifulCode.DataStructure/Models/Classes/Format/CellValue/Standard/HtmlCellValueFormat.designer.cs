...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class HtmlCellValueFormat : IModel<HtmlCellValueFormat>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="HtmlCellValueFormat"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(HtmlCellValueFormat left, HtmlCellValueFormat right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="HtmlCellValueFormat"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(HtmlCellValueFormat left, HtmlCellValueFormat right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(HtmlCellValueFormat other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as HtmlCellValueFormat);
        ...
        /// <inheritdoc />
        public new HtmlCellValueFormat DeepClone() => (HtmlCellValueFormat)this.DeepCloneInternal();
        ...
        public override StandardCellValueFormatBase<string> DeepCloneWithMissingValueText(string missingValueText)
        {
        ...
        /// <inheritdoc />
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        protected override CellValueFormatBase<string> DeepCloneInternal()
        {
            var result = new HtmlCellValueFormat(
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.HtmlCellValueFormat: MissingValueText = {this.MissingValueText?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
