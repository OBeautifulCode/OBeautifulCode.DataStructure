    ...
    public partial class PercentCellValueFormat<TValue> : IModel<PercentCellValueFormat<TValue>>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.PercentDisplayKind, options, propertyPathTracker, nameof(this.PercentDisplayKind));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
