...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class Column : IModel<Column>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="Column"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="Column"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as Column);
        ...
        /// <returns>New <see cref="Column" /> using the specified <paramref name="id" /> for <see cref="Id" /> and a deep clone of every other property.</returns>
        ...
        public Column DeepCloneWithId(string id)
        {
            var result = new Column(
                                 id,
                                 this.Format?.DeepClone(),
        ...
        /// <returns>New <see cref="Column" /> using the specified <paramref name="format" /> for <see cref="Format" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        /// <returns>New <see cref="Column" /> using the specified <paramref name="valueFormat" /> for <see cref="ValueFormat" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public Column DeepCloneWithValueFormat(ICellValueFormat valueFormat)
        {
            var result = new Column(
                                 this.Id?.DeepClone(),
                                 this.Format?.DeepClone(),
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.Column: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Format = {this.Format?.ToString() ?? "<null>"}, ValueFormat = {this.ValueFormat?.ToString() ?? "<null>"}.");
