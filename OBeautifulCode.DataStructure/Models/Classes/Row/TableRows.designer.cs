...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class TableRows : IModel<TableRows>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.TableRows: HeaderRows = {this.HeaderRows?.ToString() ?? "<null>"}, DataRows = {this.DataRows?.ToString() ?? "<null>"}, RowsFormat = {this.RowsFormat?.ToString() ?? "<null>"}.");
