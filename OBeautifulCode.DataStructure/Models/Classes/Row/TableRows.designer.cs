    ...
    public partial class TableRows : IModel<TableRows>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.HeaderRows, options, propertyPathTracker, nameof(this.HeaderRows));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DataRows, options, propertyPathTracker, nameof(this.DataRows));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.FooterRows, options, propertyPathTracker, nameof(this.FooterRows));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
