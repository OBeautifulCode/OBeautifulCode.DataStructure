...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class FooterRows : IModel<FooterRows>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="FooterRows"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(FooterRows left, FooterRows right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="FooterRows"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(FooterRows left, FooterRows right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(FooterRows other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as FooterRows);
        ...
        /// <returns>New <see cref="FooterRows" /> using the specified <paramref name="rows" /> for <see cref="Rows" /> and a deep clone of every other property.</returns>
        ...
        public FooterRows DeepCloneWithRows(IReadOnlyList<FlatRow> rows)
        {
            var result = new FooterRows(
                                 rows,
                                 this.Format?.DeepClone());
        ...
        /// <returns>New <see cref="FooterRows" /> using the specified <paramref name="format" /> for <see cref="Format" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.FooterRows: Rows = {this.Rows?.ToString() ?? "<null>"}, Format = {this.Format?.ToString() ?? "<null>"}.");
