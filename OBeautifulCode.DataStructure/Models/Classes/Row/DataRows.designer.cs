...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class DataRows : IModel<DataRows>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DataRows"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DataRows left, DataRows right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DataRows"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DataRows left, DataRows right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(DataRows other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DataRows);
        ...
        /// <returns>New <see cref="DataRows" /> using the specified <paramref name="rows" /> for <see cref="Rows" /> and a deep clone of every other property.</returns>
        ...
        /// <returns>New <see cref="DataRows" /> using the specified <paramref name="format" /> for <see cref="Format" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.DataRows: Rows = {this.Rows?.ToString() ?? "<null>"}, Format = {this.Format?.ToString() ?? "<null>"}.");
