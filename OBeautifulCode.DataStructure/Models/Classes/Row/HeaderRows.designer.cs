...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class HeaderRows : IModel<HeaderRows>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="HeaderRows"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(HeaderRows left, HeaderRows right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="HeaderRows"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(HeaderRows left, HeaderRows right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(HeaderRows other)
        {
            ...
            var result = this.Rows.IsEqualTo(other.Rows)
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as HeaderRows);
        ...
        /// <returns>New <see cref="HeaderRows" /> using the specified <paramref name="rows" /> for <see cref="Rows" /> and a deep clone of every other property.</returns>
        ...
        public HeaderRows DeepCloneWithRows(IReadOnlyList<FlatRow> rows)
        {
            var result = new HeaderRows(
                                 rows,
                                 this.Format?.DeepClone());
        ...
        /// <returns>New <see cref="HeaderRows" /> using the specified <paramref name="format" /> for <see cref="Format" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public HeaderRows DeepCloneWithFormat(HeaderRowsFormat format)
        {
            var result = new HeaderRows(
                                 this.Rows?.DeepClone(),
                                 format);
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.HeaderRows: Rows = {this.Rows?.ToString() ?? "<null>"}, Format = {this.Format?.ToString() ?? "<null>"}.");
