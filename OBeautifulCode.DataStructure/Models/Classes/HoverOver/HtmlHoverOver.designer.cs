...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class HtmlHoverOver : IModel<HtmlHoverOver>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="HtmlHoverOver"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(HtmlHoverOver left, HtmlHoverOver right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="HtmlHoverOver"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(HtmlHoverOver left, HtmlHoverOver right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(HtmlHoverOver other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as HtmlHoverOver);
        ...
        /// <inheritdoc />
        public new HtmlHoverOver DeepClone() => (HtmlHoverOver)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="HtmlHoverOver" /> using the specified <paramref name="html" /> for <see cref="Html" /> and a deep clone of every other property.</returns>
        ...
        public HtmlHoverOver DeepCloneWithHtml(string html)
        {
        ...
        /// <inheritdoc />
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        protected override HoverOverBase DeepCloneInternal()
        {
            var result = new HtmlHoverOver(
                                 this.Html?.DeepClone());
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.HtmlHoverOver: Html = {this.Html?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Html, options, propertyPathTracker, nameof(this.Html));
