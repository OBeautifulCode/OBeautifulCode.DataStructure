    ...
    public partial class DropdownSelector : IModel<DropdownSelector>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Items, options, propertyPathTracker, nameof(this.Items));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.SelectedItemName, options, propertyPathTracker, nameof(this.SelectedItemName));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
