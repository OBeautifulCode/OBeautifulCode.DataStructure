    ...
    public partial class SlottedCell : IModel<SlottedCell>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.SlotIdToCellMap, options, propertyPathTracker, nameof(this.SlotIdToCellMap));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DefaultSlotId, options, propertyPathTracker, nameof(this.DefaultSlotId));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
