...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class NullCell : IModel<NullCell>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.NullCell: Format = {this.Format?.ToString() ?? "<null>"}, HoverOver = {this.HoverOver?.ToString() ?? "<null>"}, Link = {this.Link?.ToString() ?? "<null>"}, DisplayValue = {this.DisplayValue?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
