...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class SlottedCell : IModel<SlottedCell>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.SlottedCell: SlotIdToCellMap = {this.SlotIdToCellMap?.ToString() ?? "<null>"}, DefaultSlotName = {this.DefaultSlotName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
