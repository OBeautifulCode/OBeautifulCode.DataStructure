...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class ColumnSpanningSlottedCell : IModel<ColumnSpanningSlottedCell>
    {
        ...
        /// <returns>New <see cref="ColumnSpanningSlottedCell" /> using the specified <paramref name="defaultSlotId" /> for <see cref="DefaultSlotId" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ColumnSpanningSlottedCell DeepCloneWithDefaultSlotId(string defaultSlotId)
        {
            var result = new ColumnSpanningSlottedCell(
                                 this.SlotIdToCellMap?.DeepClone(),
                                 defaultSlotId,
