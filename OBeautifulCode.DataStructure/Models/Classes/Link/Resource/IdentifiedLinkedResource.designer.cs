    ...
    public partial class IdentifiedLinkedResource : IModel<IdentifiedLinkedResource>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.AdditionalInfoIdToValueMap, options, propertyPathTracker, nameof(this.AdditionalInfoIdToValueMap));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
