...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class LogoDetails : IModel<LogoDetails>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="LogoDetails"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(LogoDetails left, LogoDetails right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="LogoDetails"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(LogoDetails left, LogoDetails right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(LogoDetails other)
        {
            ...
            var result = this.Media.IsEqualTo(other.Media);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as LogoDetails);
        ...
        /// <inheritdoc />
        public new LogoDetails DeepClone() => (LogoDetails)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="LogoDetails" /> using the specified <paramref name="media" /> for <see cref="Media" /> and a deep clone of every other property.</returns>
        ...
        public LogoDetails DeepCloneWithMedia(IMedia media)
        {
        ...
        /// <inheritdoc />
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        protected override DetailsBase DeepCloneInternal()
        {
            var result = new LogoDetails(
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.LogoDetails: Media = {this.Media?.ToString() ?? "<null>"}.");
