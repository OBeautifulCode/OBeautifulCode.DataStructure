...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class AvailabilityCheck : IModel<AvailabilityCheck>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.AvailabilityCheck: Operation = {this.Operation?.ToString() ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
