...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class AvailabilityCheckResult : IModel<AvailabilityCheckResult>
    {
        ...
        public bool Equals(AvailabilityCheckResult other)
        {
            ...
            var result = this.Availability.IsEqualTo(other.Availability)
        ...
        /// <returns>New <see cref="AvailabilityCheckResult" /> using the specified <paramref name="availability" /> for <see cref="Availability" /> and a deep clone of every other property.</returns>
        ...
        public AvailabilityCheckResult DeepCloneWithAvailability(Availability availability)
        {
            var result = new AvailabilityCheckResult(
                                 availability,
                                 this.MessageOp?.DeepClone());
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.AvailabilityCheckResult: Availability = {this.Availability.ToString() ?? "<null>"}, MessageOp = {this.MessageOp?.ToString() ?? "<null>"}.");
