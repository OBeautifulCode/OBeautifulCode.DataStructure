...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class Validation : IModel<Validation>
    {
        ...
        /// <returns>New <see cref="Validation" /> using the specified <paramref name="operation" /> for <see cref="Operation" /> and a deep clone of every other property.</returns>
        ...
        /// <returns>New <see cref="Validation" /> using the specified <paramref name="messageFormatKind" /> for <see cref="MessageFormatKind" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public Validation DeepCloneWithMessageFormatKind(MessageFormatKind? messageFormatKind)
        {
            var result = new Validation(
                                 this.Operation?.DeepClone(),
                                 messageFormatKind,
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.Validation: Operation = {this.Operation?.ToString() ?? "<null>"}, MessageFormatKind = {this.MessageFormatKind?.ToString() ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MessageFormatKind, options, propertyPathTracker, nameof(this.MessageFormatKind));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
