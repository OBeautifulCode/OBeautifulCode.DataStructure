...
namespace OBeautifulCode.DataStructure
{
    ...
    public partial class Validation : IModel<Validation>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.Validation: Operation = {this.Operation?.ToString() ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
