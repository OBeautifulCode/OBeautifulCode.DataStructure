...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class MessageByOpBooleanValidationStep : IModel<MessageByOpBooleanValidationStep>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="MessageByOpBooleanValidationStep"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(MessageByOpBooleanValidationStep left, MessageByOpBooleanValidationStep right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="MessageByOpBooleanValidationStep"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(MessageByOpBooleanValidationStep left, MessageByOpBooleanValidationStep right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(MessageByOpBooleanValidationStep other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as MessageByOpBooleanValidationStep);
        ...
        /// <inheritdoc />
        public new MessageByOpBooleanValidationStep DeepClone() => (MessageByOpBooleanValidationStep)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="MessageByOpBooleanValidationStep" /> using the specified <paramref name="operation" /> for <see cref="Operation" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public MessageByOpBooleanValidationStep DeepCloneWithOperation(IReturningOperation<bool> operation)
        {
            var result = new MessageByOpBooleanValidationStep(
                                 operation,
                                 this.StopMessageOp?.DeepClone(),
        ...
        /// <returns>New <see cref="MessageByOpBooleanValidationStep" /> using the specified <paramref name="stopMessageOp" /> for <see cref="StopMessageOp" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public MessageByOpBooleanValidationStep DeepCloneWithStopMessageOp(IReturningOperation<string> stopMessageOp)
        {
            var result = new MessageByOpBooleanValidationStep(
                                 this.Operation?.DeepClone(),
                                 stopMessageOp,
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.MessageByOpBooleanValidationStep: Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, TrueAction = {this.TrueAction.ToString() ?? "<null>"}, FalseAction = {this.FalseAction.ToString() ?? "<null>"}, Operation = {this.Operation?.ToString() ?? "<null>"}, StopMessageOp = {this.StopMessageOp?.ToString() ?? "<null>"}.");
