    ...
    public partial class ValidationResult : IModel<ValidationResult>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ValidityOp, options, propertyPathTracker, nameof(this.ValidityOp));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MessageOp, options, propertyPathTracker, nameof(this.MessageOp));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
