    ...
    public partial class TreeTable : IModel<TreeTable>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TableColumns, options, propertyPathTracker, nameof(this.TableColumns));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TableRows, options, propertyPathTracker, nameof(this.TableRows));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
