...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class CellOpExecutionCompletedEvent<TResult> : IModel<CellOpExecutionCompletedEvent<TResult>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="CellOpExecutionCompletedEvent{TResult}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(CellOpExecutionCompletedEvent<TResult> left, CellOpExecutionCompletedEvent<TResult> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="CellOpExecutionCompletedEvent{TResult}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(CellOpExecutionCompletedEvent<TResult> left, CellOpExecutionCompletedEvent<TResult> right) => !(left == right);
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as CellOpExecutionCompletedEvent<TResult>);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash(this.TimestampUtc)
            .Hash(this.Details)
            .Hash(this.ExecutionResult)
            .Value;

        /// <inheritdoc />
        public new CellOpExecutionCompletedEvent<TResult> DeepClone() => (CellOpExecutionCompletedEvent<TResult>)this.DeepCloneInternal();
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="ExecutionResult" />.
        /// </summary>
        /// <param name="executionResult">The new <see cref="ExecutionResult" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="CellOpExecutionCompletedEvent{TResult}" /> using the specified <paramref name="executionResult" /> for <see cref="ExecutionResult" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.{this.GetType().ToStringReadable()}: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ExecutionResult = {this.ExecutionResult?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ExecutionResult, options, propertyPathTracker, nameof(this.ExecutionResult));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
