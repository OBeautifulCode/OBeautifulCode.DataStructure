...
namespace OBeautifulCode.DataStructure
{
    ...
    [Serializable]
    public partial class CheckAvailabilityOp : IModel<CheckAvailabilityOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="CheckAvailabilityOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(CheckAvailabilityOp left, CheckAvailabilityOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="CheckAvailabilityOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(CheckAvailabilityOp left, CheckAvailabilityOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(CheckAvailabilityOp other)
        {
            ...
            var result = this.AvailabilityCheckChain.IsEqualTo(other.AvailabilityCheckChain);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as CheckAvailabilityOp);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash(this.AvailabilityCheckChain)
            .Value;

        /// <inheritdoc />
        public new CheckAvailabilityOp DeepClone() => (CheckAvailabilityOp)this.DeepCloneInternal();

        /// <summary>
        /// Deep clones this object with a new <see cref="AvailabilityCheckChain" />.
        /// </summary>
        /// <param name="availabilityCheckChain">The new <see cref="AvailabilityCheckChain" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="CheckAvailabilityOp" /> using the specified <paramref name="availabilityCheckChain" /> for <see cref="AvailabilityCheckChain" /> and a deep clone of every other property.</returns>
        ...
        {
            var result = new CheckAvailabilityOp(
                                 this.AvailabilityCheckChain?.DeepClone());
        ...
        {
            var result = Invariant($"OBeautifulCode.DataStructure.CheckAvailabilityOp: AvailabilityCheckChain = {this.AvailabilityCheckChain?.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.AvailabilityCheckChain, options, propertyPathTracker, nameof(this.AvailabilityCheckChain));
